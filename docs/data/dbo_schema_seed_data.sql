...
-- MODULE 1: MASTER DATA
-- =============================================================================================================
PRINT 'Inserting StatusLookup for employment type...';
INSERT INTO dbo.StatusLookup (StatusCode, StatusGroup, Label, DisplayOrder, IsTerminal) VALUES
('FULL_TIME',       'EMPLOYMENT_TYPE',      'Full-Time',        1,      0),
('PART_TIME',       'EMPLOYMENT_TYPE',      'Part-Time',        2,      0),
('CONTRACT',        'EMPLOYMENT_TYPE',      'Contract',         3,      0),
('TEMPORARY',       'EMPLOYMENT_TYPE',      'Temporary',        4,      0),
('INTERNSHIP',      'EMPLOYMENT_TYPE',      'Internship',       5,      0),
('CONSULTANT',      'EMPLOYMENT_TYPE',      'Consultant',       6,      0),
('PROBATION',       'EMPLOYMENT_TYPE',      'Probation',        7,      0),
('TRAINEE',         'EMPLOYMENT_TYPE',      'Trainee',          8,      0),
('APPRENTICE',      'EMPLOYMENT_TYPE',      'Apprentice',       9,      0);


PRINT 'Inserting StatusLookup for contact type...';
INSERT INTO dbo.StatusLookup (StatusCode, StatusGroup, Label, DisplayOrder, IsTerminal) VALUES
('WORK_EMAIL',        'CONTACT_TYPE',    'Work Email',         1,    0),
('PERSONAL_EMAIL',    'CONTACT_TYPE',    'Personal Email',     2,    0),
('WORK_PHONE',        'CONTACT_TYPE',    'Work Phone',         3,    0),
('PERSONAL_PHONE',    'CONTACT_TYPE',    'Personal Phone',     4,    0),
('MOBILE',            'CONTACT_TYPE',    'Mobile',             5,    0),
('WHATSAPP',          'CONTACT_TYPE',    'WhatsApp',           6,    0),
('SLACK',             'CONTACT_TYPE',    'Slack',              7,    0),
('TEAMS',             'CONTACT_TYPE',    'Microsoft Teams',    8,    0),
('LINKEDIN',          'CONTACT_TYPE',    'LinkedIn',           9,    0),
('EMERGENCY_CONTACT', 'CONTACT_TYPE',    'Emergency Contact', 10,    0);
...
-- Mumbai HQ
('EMP001', 'Rajesh',      'Sharma',     'Dr. Rajesh Sharma',      'rajesh.sharma@medcareindia.com',       '9810001001', (SELECT Id FROM Designation WHERE DesignationCode='CHMO'),         'hi', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2012-01-15', 'FULL_TIME', 'Chief Medical Officer with 20+ years of healthcare leadership.'),
('EMP002', 'Priya',       'Nair',       'Dr. Priya Nair',         'priya.nair@medcareindia.com',          '9810001002', (SELECT Id FROM Designation WHERE DesignationCode='MEDDIRECTOR'),   'en', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2014-03-01', 'FULL_TIME', 'Medical Director specializing in hospital governance.'),
('EMP003', 'Arjun',       'Mehta',      'Dr. Arjun Mehta',        'arjun.mehta@medcareindia.com',         '9810001003', (SELECT Id FROM Designation WHERE DesignationCode='SRSURGEON'),     'hi', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2015-06-10', 'FULL_TIME', 'Senior Cardiac Surgeon, MBBS, MS, MCh Cardiology.'),
('EMP004', 'Sunita',      'Pillai',     'Sunita Pillai',          'sunita.pillai@medcareindia.com',       '9810001004', (SELECT Id FROM Designation WHERE DesignationCode='CHFNURSE'),      'ml', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2013-08-20', 'FULL_TIME', 'Chief Nursing Officer, 18 years of nursing excellence.'),
('EMP005', 'Vikram',      'Gupta',      'Vikram Gupta',           'vikram.gupta@medcareindia.com',        '9810001005', (SELECT Id FROM Designation WHERE DesignationCode='HRMANAGER'),     'hi', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2016-02-14', 'FULL_TIME', 'HR Manager handling all India HR operations.'),
('EMP006', 'Sneha',       'Desai',      'Sneha Desai',            'sneha.desai@medcareindia.com',         '9810001006', (SELECT Id FROM Designation WHERE DesignationCode='FINMANAGER'),    'mr', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2015-09-01', 'FULL_TIME', 'Finance Manager overseeing hospital billing and payroll.'),
('EMP007', 'Ramesh',      'Iyer',       'Ramesh Iyer',            'ramesh.iyer@medcareindia.com',         '9810001007', (SELECT Id FROM Designation WHERE DesignationCode='ITMANAGER'),     'ta', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2017-04-01', 'FULL_TIME', 'IT Manager managing EHR and hospital network infrastructure.'),
('EMP008', 'Kavitha',     'Rao',        'Dr. Kavitha Rao',        'kavitha.rao@medcareindia.com',         '9810001008', (SELECT Id FROM Designation WHERE DesignationCode='CONSULTANT'),    'te', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2018-07-15', 'FULL_TIME', 'Consultant Physician, Internal Medicine.'),
('EMP009', 'Anil',        'Khanna',     'Dr. Anil Khanna',        'anil.khanna@medcareindia.com',         '9810001009', (SELECT Id FROM Designation WHERE DesignationCode='RESIDENTDR'),   'hi', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2021-08-01', 'FULL_TIME', 'Resident Doctor, Cardiology rotation.'),
('EMP010', 'Meena',       'Joshi',      'Meena Joshi',            'meena.joshi@medcareindia.com',         '9810001010', (SELECT Id FROM Designation WHERE DesignationCode='SRNURSE'),      'mr', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2019-03-10', 'FULL_TIME', 'Senior Staff Nurse, ICU specialist.'),
('EMP011', 'Deepak',      'Singh',      'Deepak Singh',           'deepak.singh@medcareindia.com',        '9810001011', (SELECT Id FROM Designation WHERE DesignationCode='STAFFNURSE'),   'hi', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2020-06-15', 'FULL_TIME', 'Staff Nurse, General Ward.'),
('EMP012', 'Lalitha',     'Krishnan',   'Lalitha Krishnan',       'lalitha.krishnan@medcareindia.com',    '9810001012', (SELECT Id FROM Designation WHERE DesignationCode='CHIEFPHARM'),   'ta', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2014-11-20', 'FULL_TIME', 'Chief Pharmacist managing central pharmacy operations.'),
('EMP013', 'Manoj',       'Verma',      'Manoj Verma',            'manoj.verma@medcareindia.com',         '9810001013', (SELECT Id FROM Designation WHERE DesignationCode='PHARMACIST'),   'hi', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2021-01-10', 'FULL_TIME', 'Pharmacist, Outpatient Pharmacy.'),
('EMP014', 'Radha',       'Patel',      'Radha Patel',            'radha.patel@medcareindia.com',         '9810001014', (SELECT Id FROM Designation WHERE DesignationCode='ADMEXEC'),      'gu', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2020-09-01', 'FULL_TIME', 'Administrative Executive, patient records.'),
('EMP015', 'Suresh',      'Naidu',      'Suresh Naidu',           'suresh.naidu@medcareindia.com',        '9810001015', (SELECT Id FROM Designation WHERE DesignationCode='FRONTDESK'),    'te', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2022-02-01', 'FULL_TIME', 'Front Desk Executive, patient registration.'),
-- Delhi
('EMP016', 'Harpreet',    'Kaur',       'Dr. Harpreet Kaur',      'harpreet.kaur@medcareindia.com',       '9810002001', (SELECT Id FROM Designation WHERE DesignationCode='MEDDIRECTOR'),  'pa', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2013-05-15', 'FULL_TIME', 'Medical Director, Delhi Super Specialty Hospital.'),
('EMP017', 'Nitin',       'Agarwal',    'Dr. Nitin Agarwal',      'nitin.agarwal@medcareindia.com',       '9810002002', (SELECT Id FROM Designation WHERE DesignationCode='SRSURGEON'),    'hi', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2016-09-01', 'FULL_TIME', 'Senior Orthopedic Surgeon.'),
('EMP018', 'Pooja',       'Bhatt',      'Pooja Bhatt',            'pooja.bhatt@medcareindia.com',         '9810002003', (SELECT Id FROM Designation WHERE DesignationCode='SRNURSE'),      'hi', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2018-03-20', 'FULL_TIME', 'Senior Staff Nurse, Delhi.'),
('EMP019', 'Kuldeep',     'Malhotra',   'Kuldeep Malhotra',       'kuldeep.malhotra@medcareindia.com',    '9810002004', (SELECT Id FROM Designation WHERE DesignationCode='HRBP'),         'hi', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2019-07-01', 'FULL_TIME', 'HR Business Partner, North India.'),
('EMP020', 'Anita',       'Saxena',     'Dr. Anita Saxena',       'anita.saxena@medcareindia.com',        '9810002005', (SELECT Id FROM Designation WHERE DesignationCode='EMERPHYSICIAN'),'hi', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2017-11-01', 'FULL_TIME', 'Emergency Medicine Physician, MBBS, MD Emergency.'),
-- Bengaluru
('EMP021', 'Subramaniam', 'Rajan',      'Dr. Subramaniam Rajan',  'subramaniam.rajan@medcareindia.com',   '9810003001', (SELECT Id FROM Designation WHERE DesignationCode='MEDDIRECTOR'),  'ta', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2014-01-10', 'FULL_TIME', 'Medical Director, Bengaluru Hospital.'),
('EMP022', 'Divya',       'Menon',      'Dr. Divya Menon',        'divya.menon@medcareindia.com',         '9810003002', (SELECT Id FROM Designation WHERE DesignationCode='CONSULTANT'),   'ml', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2019-04-15', 'FULL_TIME', 'Consultant Neurologist.'),
('EMP023', 'Karthik',     'Sundaram',   'Karthik Sundaram',       'karthik.sundaram@medcareindia.com',    '9810003003', (SELECT Id FROM Designation WHERE DesignationCode='RADIOLOGIST'),  'ta', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2017-06-01', 'FULL_TIME', 'Radiologist, CT & MRI specialist.'),
('EMP024', 'Ananya',      'Bose',       'Ananya Bose',            'ananya.bose@medcareindia.com',         '9810003004', (SELECT Id FROM Designation WHERE DesignationCode='LABTECH'),      'bn', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2021-05-01', 'FULL_TIME', 'Laboratory Technician, Microbiology.'),
('EMP025', 'Prasad',      'Kulkarni',   'Prasad Kulkarni',        'prasad.kulkarni@medcareindia.com',     '9810003005', (SELECT Id FROM Designation WHERE DesignationCode='SYSADMIN'),     'mr', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2020-10-01', 'FULL_TIME', 'Systems Administrator, EHR and network.'),
-- Chennai
('EMP026', 'Lakshmi',     'Venkatesh',  'Dr. Lakshmi Venkatesh',  'lakshmi.venkatesh@medcareindia.com',   '9810004001', (SELECT Id FROM Designation WHERE DesignationCode='MEDDIRECTOR'),  'ta', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2011-08-01', 'FULL_TIME', 'Medical Director, Chennai Hospital, Oncology specialist.'),
('EMP027', 'Balachandran','Kumar',      'Dr. Balachandran Kumar', 'balachandran.kumar@medcareindia.com',  '9810004002', (SELECT Id FROM Designation WHERE DesignationCode='CONSULTANT'),   'ta', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2018-02-01', 'FULL_TIME', 'Consultant Oncologist, MBBS, MD, DM Oncology.'),
('EMP028', 'Revathi',     'Suresh',     'Revathi Suresh',         'revathi.suresh@medcareindia.com',      '9810004003', (SELECT Id FROM Designation WHERE DesignationCode='STAFFNURSE'),   'ta', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2022-01-10', 'FULL_TIME', 'Staff Nurse, Oncology ward.'),
('EMP029', 'Murali',      'Dharan',     'Murali Dharan',          'murali.dharan@medcareindia.com',       '9810004004', (SELECT Id FROM Designation WHERE DesignationCode='SRPHARM'),      'ta', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2019-11-01', 'FULL_TIME', 'Senior Pharmacist, Oncology drug management.'),
('EMP030', 'Sangeetha',   'Arumugam',   'Sangeetha Arumugam',     'sangeetha.arumugam@medcareindia.com',  '9810004005', (SELECT Id FROM Designation WHERE DesignationCode='HREXEC'),       'ta', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2023-03-01', 'FULL_TIME', 'HR Executive, Chennai HR operations.'),
-- Hyderabad
('EMP031', 'Venkat',      'Reddy',      'Dr. Venkat Reddy',       'venkat.reddy@medcareindia.com',        '9810005001', (SELECT Id FROM Designation WHERE DesignationCode='MEDDIRECTOR'),  'te', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2013-12-01', 'FULL_TIME', 'Medical Director, Hyderabad Hospital.'),
('EMP032', 'Bhavana',     'Rao',        'Dr. Bhavana Rao',        'bhavana.rao@medcareindia.com',         '9810005002', (SELECT Id FROM Designation WHERE DesignationCode='CONSULTANT'),   'te', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2017-09-01', 'FULL_TIME', 'Consultant Pediatrician.'),
('EMP033', 'Ravi',        'Chandra',    'Ravi Chandra',           'ravi.chandra@medcareindia.com',        '9810005003', (SELECT Id FROM Designation WHERE DesignationCode='RADTECH'),      'te', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2021-06-01', 'FULL_TIME', 'Radiology Technician, X-Ray and Ultrasound.'),
('EMP034', 'Padma',       'Devi',       'Padma Devi',             'padma.devi@medcareindia.com',          '9810005004', (SELECT Id FROM Designation WHERE DesignationCode='JRNURSE'),      'te', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2023-01-15', 'FULL_TIME', 'Junior Staff Nurse, General Ward.'),
('EMP035', 'Sunil',       'Babu',       'Sunil Babu',             'sunil.babu@medcareindia.com',          '9810005005', (SELECT Id FROM Designation WHERE DesignationCode='ACCOUNTANT'),   'te', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2020-08-01', 'FULL_TIME', 'Accountant, hospital billing and insurance claims.'),
-- Kolkata
('EMP036', 'Debashish',   'Ghosh',      'Dr. Debashish Ghosh',    'debashish.ghosh@medcareindia.com',     '9810006001', (SELECT Id FROM Designation WHERE DesignationCode='MEDDIRECTOR'),  'bn', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2014-07-01', 'FULL_TIME', 'Medical Director, Kolkata Hospital.'),
('EMP037', 'Ankita',      'Chatterjee', 'Dr. Ankita Chatterjee',  'ankita.chatterjee@medcareindia.com',   '9810006002', (SELECT Id FROM Designation WHERE DesignationCode='PATHOLOGIST'),  'bn', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2018-10-01', 'FULL_TIME', 'Pathologist, MBBS, MD Pathology.'),
('EMP038', 'Soumya',      'Das',        'Soumya Das',             'soumya.das@medcareindia.com',          '9810006003', (SELECT Id FROM Designation WHERE DesignationCode='STAFFNURSE'),   'bn', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2021-04-01', 'FULL_TIME', 'Staff Nurse, Pathology support.'),
('EMP039', 'Tapas',       'Banerjee',   'Tapas Banerjee',         'tapas.banerjee@medcareindia.com',      '9810006004', (SELECT Id FROM Designation WHERE DesignationCode='OPSMGR'),       'bn', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2016-05-01', 'FULL_TIME', 'Operations Manager, Kolkata Hospital.'),
('EMP040', 'Rupa',        'Mondal',     'Rupa Mondal',            'rupa.mondal@medcareindia.com',         '9810006005', (SELECT Id FROM Designation WHERE DesignationCode='PARAMEDICOFF'), 'bn', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2022-09-01', 'FULL_TIME', 'Paramedic Officer, Emergency response.'),
-- Pune
('EMP041', 'Shyam',       'Kulkarni',   'Dr. Shyam Kulkarni',     'shyam.kulkarni@medcareindia.com',      '9810007001', (SELECT Id FROM Designation WHERE DesignationCode='HOPADMIN'),     'mr', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2015-11-01', 'FULL_TIME', 'Hospital Administrator, Pune.'),
('EMP042', 'Namrata',     'Deshpande',  'Dr. Namrata Deshpande',  'namrata.deshpande@medcareindia.com',   '9810007002', (SELECT Id FROM Designation WHERE DesignationCode='CONSULTANT'),   'mr', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2019-02-01', 'FULL_TIME', 'Consultant Cardiologist.'),
('EMP043', 'Rohit',       'Patil',      'Rohit Patil',            'rohit.patil@medcareindia.com',         '9810007003', (SELECT Id FROM Designation WHERE DesignationCode='JRRESIDENT'),   'mr', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2023-08-01', 'FULL_TIME', 'Junior Resident, rotating departments.'),
('EMP044', 'Ashwini',     'More',       'Ashwini More',           'ashwini.more@medcareindia.com',        '9810007004', (SELECT Id FROM Designation WHERE DesignationCode='STAFFNURSE'),   'mr', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2020-12-01', 'FULL_TIME', 'Staff Nurse, Cardiology Ward.'),
('EMP045', 'Ganesh',      'Shinde',     'Ganesh Shinde',          'ganesh.shinde@medcareindia.com',       '9810007005', (SELECT Id FROM Designation WHERE DesignationCode='WARDBOY'),      'mr', (SELECT Id FROM TimeZoneMaster WHERE TimeZoneCode='IST'), '2022-06-01', 'FULL_TIME', 'Ward Boy, Cardiology and General wards.');
...
((SELECT Id FROM Employee WHERE EmployeeCode='EMP001'), 'WORK_PHONE',           '+91-22-40001001',                      1),
((SELECT Id FROM Employee WHERE EmployeeCode='EMP001'), 'PERSONAL_EMAIL',       'rajesh.sharma.personal@gmail.com',     0),
((SELECT Id FROM Employee WHERE EmployeeCode='EMP002'), 'WORK_PHONE',           '+91-22-40001002',                      1),
((SELECT Id FROM Employee WHERE EmployeeCode='EMP004'), 'WORK_PHONE',           '+91-22-40001004',                      1),
((SELECT Id FROM Employee WHERE EmployeeCode='EMP005'), 'WORK_PHONE',           '+91-22-40001005',                      1),
((SELECT Id FROM Employee WHERE EmployeeCode='EMP005'), 'SLACK',                '@vikram.gupta',                        0),
((SELECT Id FROM Employee WHERE EmployeeCode='EMP007'), 'WORK_PHONE',           '+91-22-40001007',                      1),
((SELECT Id FROM Employee WHERE EmployeeCode='EMP007'), 'SLACK',                '@ramesh.iyer.it',                      0),
((SELECT Id FROM Employee WHERE EmployeeCode='EMP016'), 'WORK_PHONE',           '+91-11-40002001',                      1),
((SELECT Id FROM Employee WHERE EmployeeCode='EMP021'), 'WORK_PHONE',           '+91-80-40003001',                      1),
((SELECT Id FROM Employee WHERE EmployeeCode='EMP026'), 'WORK_PHONE',           '+91-44-40004001',                      1),
((SELECT Id FROM Employee WHERE EmployeeCode='EMP031'), 'WORK_PHONE',           '+91-40-40005001',                      1),
((SELECT Id FROM Employee WHERE EmployeeCode='EMP036'), 'WORK_PHONE',           '+91-33-40006001',                      1);
