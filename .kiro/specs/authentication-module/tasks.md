...
- [ ] 2. Implement persistence layer with EF Core
  ...
  - [~] 2.2 Create DbContext and entity configurations
  ...
  - [~] 2.5 Create DI registration extension
...
- [ ] 3. Implement application layer core services
  - [~] 3.1 Add required NuGet packages to Application project
...
│   │   │   ├── SdxCore.Identity.Domain
│   │   │   └── SdxCore.Identity.Persistence
│   │   ├── Product/ (example microservice - placeholder)
│   │   │   ├── SdxCore.Product.API
│   │   │   ├── SdxCore.Product.Application
│   │   │   ├── SdxCore.Product.Domain
│   │   │   └── SdxCore.Product.Persistence
│   │   └── Order/ (example microservice - placeholder)
│   │       ├── SdxCore.Order.API
│   │       ├── SdxCore.Order.Application
│   │       ├── SdxCore.Order.Domain
│   │       └── SdxCore.Order.Persistence
│   └── BuildingBlocks/ (shared code)
│       ├── SdxCore.SharedKernel
│       ├── SdxCore.Common
│       └── SdxCore.Contracts
