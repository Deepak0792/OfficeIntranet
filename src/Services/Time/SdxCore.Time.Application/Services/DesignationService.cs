...
public class DesignationService(
    ...
    ITimeUnitOfWork unitOfWork) : IDesignationService
{
    ...
    public async Task<IEnumerable<DesignationResponse>> GetAllAsync(CancellationToken cancellationToken = default)
    {
        ...
        return await _cacheService.GetOrSetAsync(cacheKey, async (ct) =>
        {
            ...
            return PropertyMapper.MapList<Designation, DesignationResponse>(entities);
    ...
    public async Task<DesignationResponse> CreateAsync(CreateDesignationRequest request, CancellationToken cancellationToken = default)
    {
        var entity = PropertyMapper.Map<CreateDesignationRequest, Designation>(request);
    ...
    public async Task<bool> UpdateAsync(Guid id, UpdateDesignationRequest request, CancellationToken cancellationToken = default)
    {
