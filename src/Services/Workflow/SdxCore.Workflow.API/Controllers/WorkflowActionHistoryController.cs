...
public class WorkflowActionHistoryController : ControllerBase
{
    ...
    public async Task<IActionResult> GetByInstance(int instanceId, CancellationToken cancellationToken)
    {
    ...
    [HttpGet("tasks/{taskId:int}/history")]
    public async Task<IActionResult> GetByTask(int taskId, CancellationToken cancellationToken)
    {
