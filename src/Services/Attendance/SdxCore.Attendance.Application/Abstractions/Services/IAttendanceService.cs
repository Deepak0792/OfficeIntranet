...
public interface IAttendanceService
{
    ...
    Task<AttendanceResponse> CheckInAsync(CheckInRequest request, CancellationToken cancellationToken = default);
    Task<AttendanceResponse> CheckOutAsync(CheckOutRequest request, CancellationToken cancellationToken = default);
