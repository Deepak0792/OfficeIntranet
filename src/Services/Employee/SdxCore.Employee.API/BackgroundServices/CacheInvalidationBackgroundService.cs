...
namespace SdxCore.Employee.API.BackgroundServices;
...
public class CacheInvalidationBackgroundService : BackgroundService
{
    ...
    private readonly string _queueName = "cache.employee.invalidate";
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        _topologyConfigurator.ConfigureTopology("employee", new[] { _queueName });
    ...
    private async Task ProcessInvalidationAsync(string? eventType, string payload, CancellationToken cancellationToken)
    {
        ...
        var pattern = cacheKeyBuilder.BuildPattern(entityName.ToLowerInvariant(), "*");
