...
INSERT INTO attendance.LeaveType (LeaveCode, LeaveName, IsPaid, MaxDaysPerYear, AllowCarryForward, RequiresApproval, AllowHalfDay) VALUES
...
INSERT INTO attendance.LeaveBalance (EmployeeId, LeaveTypeId, BalanceYear, OpeningBalance, Allocated, Availed, Encashed, CarryForward, LastUpdatedAt) VALUES
-- EMP001 CMO
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP001'), (SELECT Id FROM attendance.LeaveType WHERE LeaveCode='EL'),  2025, 5.00, 18.00, 0.00,  0.00, 5.00, GETUTCDATE()),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP001'), (SELECT Id FROM attendance.LeaveType WHERE LeaveCode='CL'),  2025, 0.00, 12.00, 0.00,  0.00, 0.00, GETUTCDATE()),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP001'), (SELECT Id FROM attendance.LeaveType WHERE LeaveCode='SL'),  2025, 0.00, 12.00, 0.00,  0.00, 0.00, GETUTCDATE()),
-- EMP009 Resident
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP009'), (SELECT Id FROM attendance.LeaveType WHERE LeaveCode='EL'),  2025, 0.00, 18.00, 0.00,  0.00, 0.00, GETUTCDATE()),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP009'), (SELECT Id FROM attendance.LeaveType WHERE LeaveCode='CL'),  2025, 0.00, 12.00, 0.00,  0.00, 0.00, GETUTCDATE()),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP009'), (SELECT Id FROM attendance.LeaveType WHERE LeaveCode='SL'),  2025, 0.00, 12.00, 3.00,  0.00, 0.00, GETUTCDATE()),
-- EMP010 Senior ICU Nurse
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP010'), (SELECT Id FROM attendance.LeaveType WHERE LeaveCode='EL'),  2025, 3.00, 18.00, 0.00,  0.00, 3.00, GETUTCDATE()),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP010'), (SELECT Id FROM attendance.LeaveType WHERE LeaveCode='CL'),  2025, 0.00, 12.00, 0.00,  0.00, 0.00, GETUTCDATE()),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP010'), (SELECT Id FROM attendance.LeaveType WHERE LeaveCode='SL'),  2025, 0.00, 12.00, 0.00,  0.00, 0.00, GETUTCDATE()),
-- EMP011 Staff Nurse
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP011'), (SELECT Id FROM attendance.LeaveType WHERE LeaveCode='EL'),  2025, 0.00, 18.00, 0.00,  0.00, 0.00, GETUTCDATE()),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP011'), (SELECT Id FROM attendance.LeaveType WHERE LeaveCode='CL'),  2025, 0.00, 12.00, 1.00,  0.00, 0.00, GETUTCDATE()),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP011'), (SELECT Id FROM attendance.LeaveType WHERE LeaveCode='SL'),  2025, 0.00, 12.00, 0.00,  0.00, 0.00, GETUTCDATE()),
-- EMP005 HR Manager
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005'), (SELECT Id FROM attendance.LeaveType WHERE LeaveCode='EL'),  2025, 7.00, 18.00, 0.00,  0.00, 7.00, GETUTCDATE()),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005'), (SELECT Id FROM attendance.LeaveType WHERE LeaveCode='CL'),  2025, 0.00, 12.00, 0.00,  0.00, 0.00, GETUTCDATE()),
...
INSERT INTO attendance.CompOffType (CompOffTypeCode, CompOffTypeName, ExpiryDays) VALUES
...
INSERT INTO attendance.CompOffBalance (EmployeeId, CompOffTypeId, EarnedDate, ExpiryDate, TotalDays, AvailedDays, AttendanceRecordId) VALUES
...
INSERT INTO attendance.WorkWeekPolicy (PolicyCode, PolicyName, Description, IsDefault) VALUES
...
INSERT INTO attendance.WorkWeekPolicyDay (WorkWeekPolicyId, DayOfWeek, IsWorkingDay, StandardWorkingMinutes, IsHalfDay) VALUES
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-ADMIN-INDIA'), 0, 0, NULL,  0), -- Sunday off
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-ADMIN-INDIA'), 1, 1, 480,   0), -- Monday
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-ADMIN-INDIA'), 2, 1, 480,   0), -- Tuesday
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-ADMIN-INDIA'), 3, 1, 480,   0), -- Wednesday
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-ADMIN-INDIA'), 4, 1, 480,   0), -- Thursday
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-ADMIN-INDIA'), 5, 1, 480,   0), -- Friday
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-ADMIN-INDIA'), 6, 0, NULL,  0); -- Saturday off

-- Mon-Sat Clinical 6-day
INSERT INTO attendance.WorkWeekPolicyDay (WorkWeekPolicyId, DayOfWeek, IsWorkingDay, StandardWorkingMinutes, IsHalfDay) VALUES
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-CLINICAL-6DAY'), 0, 0, NULL, 0), -- Sunday off
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-CLINICAL-6DAY'), 1, 1, 480,  0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-CLINICAL-6DAY'), 2, 1, 480,  0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-CLINICAL-6DAY'), 3, 1, 480,  0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-CLINICAL-6DAY'), 4, 1, 480,  0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-CLINICAL-6DAY'), 5, 1, 480,  0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-CLINICAL-6DAY'), 6, 1, 240,  1); -- Saturday half-day

-- Nursing 7-day (8h shifts, roster-driven off)
INSERT INTO attendance.WorkWeekPolicyDay (WorkWeekPolicyId, DayOfWeek, IsWorkingDay, StandardWorkingMinutes, IsHalfDay) VALUES
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-NURSING-SHIFT'), 0, 1, 480, 0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-NURSING-SHIFT'), 1, 1, 480, 0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-NURSING-SHIFT'), 2, 1, 480, 0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-NURSING-SHIFT'), 3, 1, 480, 0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-NURSING-SHIFT'), 4, 1, 480, 0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-NURSING-SHIFT'), 5, 1, 480, 0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-NURSING-SHIFT'), 6, 1, 480, 0);

-- Emergency 7-day
INSERT INTO attendance.WorkWeekPolicyDay (WorkWeekPolicyId, DayOfWeek, IsWorkingDay, StandardWorkingMinutes, IsHalfDay) VALUES
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-EMERGENCY-7DAY'), 0, 1, 720, 0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-EMERGENCY-7DAY'), 1, 1, 720, 0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-EMERGENCY-7DAY'), 2, 1, 720, 0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-EMERGENCY-7DAY'), 3, 1, 720, 0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-EMERGENCY-7DAY'), 4, 1, 720, 0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-EMERGENCY-7DAY'), 5, 1, 720, 0),
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-EMERGENCY-7DAY'), 6, 1, 720, 0);


PRINT 'Inserting WorkWeekPolicyAssignment...';
-- Global default: Admin policy
INSERT INTO attendance.WorkWeekPolicyAssignment (WorkWeekPolicyId, ScopeTypeId, ScopeReferenceId, EffectiveFrom, PriorityOrder) VALUES
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-ADMIN-INDIA'),
 (SELECT Id FROM time.ScopeType WHERE ScopeCode='GLOBAL'), 1, '2012-01-01', 1);

-- Clinical departments - 6-day
INSERT INTO attendance.WorkWeekPolicyAssignment (WorkWeekPolicyId, ScopeTypeId, ScopeReferenceId, EffectiveFrom, PriorityOrder) VALUES
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-CLINICAL-6DAY'),
...
INSERT INTO attendance.WorkWeekPolicyAssignment (WorkWeekPolicyId, ScopeTypeId, ScopeReferenceId, EffectiveFrom, PriorityOrder) VALUES
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-NURSING-SHIFT'),
...
-- Emergency - 7-day
INSERT INTO attendance.WorkWeekPolicyAssignment (WorkWeekPolicyId, ScopeTypeId, ScopeReferenceId, EffectiveFrom, PriorityOrder) VALUES
((SELECT Id FROM attendance.WorkWeekPolicy WHERE PolicyCode='WWP-EMERGENCY-7DAY'),
...
INSERT INTO attendance.ShiftSwapStatus (StatusCode, StatusName) VALUES
...
INSERT INTO attendance.ShiftAssignment (ShiftId, ScopeTypeId, ScopeReferenceId, EffectiveFrom, PriorityOrder, IsPrimaryShift) VALUES
((SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-GEN'),
 (SELECT Id FROM time.ScopeType WHERE ScopeCode='GLOBAL'), 1, '2012-01-01', 1, 1);
...
((SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-FLEX'),
...
((SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-OPD'),
...
((SELECT Id FROM attendance.RotationShift WHERE RotationCode='ROT-EMER-12HR'), 1, (SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-EMER-D'), 2, 0),
((SELECT Id FROM attendance.RotationShift WHERE RotationCode='ROT-EMER-12HR'), 2, NULL,                                                 1, 1),
((SELECT Id FROM attendance.RotationShift WHERE RotationCode='ROT-EMER-12HR'), 3, (SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-EMER-N'), 2, 0),
((SELECT Id FROM attendance.RotationShift WHERE RotationCode='ROT-EMER-12HR'), 4, NULL,                                                 1, 1);
...
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP001'), '2025-04-01', (SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-GEN'),  0, 0, '2025-04-01 09:00:00', '2025-04-01 18:00:00'),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP001'), '2025-04-02', (SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-GEN'),  0, 0, '2025-04-02 09:00:00', '2025-04-02 18:00:00'),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP001'), '2025-04-03', (SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-GEN'),  0, 0, '2025-04-03 09:00:00', '2025-04-03 18:00:00'),
-- EMP010 ICU Senior Nurse - Morning shift
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP010'), '2025-04-01', (SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-MORN'), 0, 0, '2025-04-01 07:00:00', '2025-04-01 15:00:00'),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP010'), '2025-04-02', (SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-AFT'),  0, 0, '2025-04-02 14:00:00', '2025-04-02 22:00:00'),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP010'), '2025-04-03', (SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-NIGHT'),0, 0, '2025-04-03 22:00:00', '2025-04-04 06:00:00'),
-- EMP020 Emergency Physician - 12-hr Day
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP020'), '2025-04-01', (SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-EMER-D'),0, 0,'2025-04-01 08:00:00', '2025-04-01 20:00:00'),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP020'), '2025-04-02', NULL,                                                1, 0, NULL, NULL), -- Off day
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP020'), '2025-04-03', (SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-EMER-N'),0, 0,'2025-04-03 20:00:00', '2025-04-04 08:00:00'),
-- EMP005 HR Manager - General shift
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005'), '2025-04-01', (SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-GEN'),  0, 0, '2025-04-01 09:00:00', '2025-04-01 18:00:00'),
...
INSERT INTO attendance.HolidayCalendar (CalendarCode, CalendarName, Description, IsDefault) VALUES
...
INSERT INTO attendance.HolidayType (HolidayTypeCode, HolidayTypeName, IsOptional) VALUES
...
-- National Holidays
INSERT INTO attendance.Holiday (HolidayCalendarId, HolidayTypeId, HolidayCode, HolidayName, HolidayDate, IsHalfDay, IsRecurring, ApplicableYear) VALUES
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-INDIA-NATIONAL'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='NATIONAL'), 'HOL-REPDAY',   'Republic Day',                     '2025-01-26', 0, 1, NULL),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-INDIA-NATIONAL'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='RELIGIOUS'),'HOL-HOLI',     'Holi',                             '2025-03-14', 0, 1, NULL),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-INDIA-NATIONAL'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='RELIGIOUS'),'HOL-UGADI',    'Ugadi / Gudi Padwa',               '2025-03-30', 0, 0, 2025),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-INDIA-NATIONAL'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='RELIGIOUS'),'HOL-GOODFRI',  'Good Friday',                      '2025-04-18', 0, 0, 2025),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-INDIA-NATIONAL'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='NATIONAL'), 'HOL-AMBEDKAR', 'Dr. B.R. Ambedkar Jayanti',        '2025-04-14', 0, 1, NULL),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-INDIA-NATIONAL'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='NATIONAL'), 'HOL-LABDAY',   'Labour Day / May Day',             '2025-05-01', 0, 1, NULL),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-INDIA-NATIONAL'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='RELIGIOUS'),'HOL-EID',      'Eid-ul-Fitr',                      '2025-03-31', 0, 0, 2025),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-INDIA-NATIONAL'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='NATIONAL'), 'HOL-INDEPDAY', 'Independence Day',                 '2025-08-15', 0, 1, NULL),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-INDIA-NATIONAL'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='RELIGIOUS'),'HOL-JANMASHTAMI','Janmashtami',                   '2025-08-16', 0, 0, 2025),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-INDIA-NATIONAL'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='NATIONAL'), 'HOL-GANDHIJAY','Gandhi Jayanti',                   '2025-10-02', 0, 1, NULL),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-INDIA-NATIONAL'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='RELIGIOUS'),'HOL-DUSSEHRA', 'Dussehra / Navratri',              '2025-10-02', 0, 0, 2025),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-INDIA-NATIONAL'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='RELIGIOUS'),'HOL-DIWALI',   'Diwali (Lakshmi Puja)',            '2025-10-20', 0, 0, 2025),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-INDIA-NATIONAL'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='RELIGIOUS'),'HOL-DIWALINEXT','Diwali Holiday',                  '2025-10-21', 0, 0, 2025),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-INDIA-NATIONAL'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='RELIGIOUS'),'HOL-CHRISTMAS', 'Christmas Day',                   '2025-12-25', 0, 1, NULL);

-- Maharashtra-specific
INSERT INTO attendance.Holiday (HolidayCalendarId, HolidayTypeId, HolidayCode, HolidayName, HolidayDate, IsHalfDay, IsRecurring) VALUES
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-MH-STATE'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='STATE'), 'HOL-MH-DAY',    'Maharashtra Day',          '2025-05-01', 0, 1),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-MH-STATE'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='STATE'), 'HOL-CHHATH',    'Chhath Puja',              '2025-10-28', 0, 0);

-- Karnataka-specific
INSERT INTO attendance.Holiday (HolidayCalendarId, HolidayTypeId, HolidayCode, HolidayName, HolidayDate, IsHalfDay, IsRecurring) VALUES
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-KA-STATE'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='STATE'), 'HOL-KA-RAJ',    'Karnataka Rajyotsava',     '2025-11-01', 0, 1);

-- Tamil Nadu-specific
INSERT INTO attendance.Holiday (HolidayCalendarId, HolidayTypeId, HolidayCode, HolidayName, HolidayDate, IsHalfDay, IsRecurring) VALUES
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-TN-STATE'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='STATE'), 'HOL-PONGAL',    'Pongal',                   '2025-01-14', 0, 1),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-TN-STATE'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='STATE'), 'HOL-PONGAL2',   'Thiruvalluvar Day',        '2025-01-15', 0, 1);

-- West Bengal-specific
INSERT INTO attendance.Holiday (HolidayCalendarId, HolidayTypeId, HolidayCode, HolidayName, HolidayDate, IsHalfDay, IsRecurring) VALUES
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-WB-STATE'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='STATE'), 'HOL-DURGA',     'Durga Puja (Maha Ashtami)','2025-10-01', 0, 0),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-WB-STATE'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='STATE'), 'HOL-DURGA2',    'Durga Puja (Navami)',      '2025-10-02', 0, 0),
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-WB-STATE'), (SELECT Id FROM attendance.HolidayType WHERE HolidayTypeCode='STATE'), 'HOL-DURGA3',    'Durga Puja (Dashami)',     '2025-10-03', 0, 0);


PRINT 'Inserting HolidayCalendarAssignment...';
-- National calendar - All offices globally
INSERT INTO attendance.HolidayCalendarAssignment (HolidayCalendarId, ScopeTypeId, ScopeReferenceId, EffectiveFrom, PriorityOrder, MergeStrategy, IsPrimary) VALUES
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-INDIA-NATIONAL'),
...
INSERT INTO attendance.HolidayCalendarAssignment (HolidayCalendarId, ScopeTypeId, ScopeReferenceId, EffectiveFrom, PriorityOrder, MergeStrategy, IsPrimary) VALUES
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-MH-STATE'),
...
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-DL-STATE'),
...
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-KA-STATE'),
...
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-TN-STATE'),
...
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-TS-STATE'),
...
((SELECT Id FROM attendance.HolidayCalendar WHERE CalendarCode='HC-WB-STATE'),
...
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP001'), '2025-04-01',
 (SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-GEN'),
 (SELECT Id FROM attendance.AttendanceStatus WHERE StatusCode='PRESENT'),
 '2025-04-01 08:52:00', '2025-04-01 18:07:00', 0, 0, 495, 7, 0),

((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005'), '2025-04-01',
 (SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-GEN'),
 (SELECT Id FROM attendance.AttendanceStatus WHERE StatusCode='LATE'),
 '2025-04-01 09:11:00', '2025-04-01 18:03:00', 11, 0, 472, 0, 0),

((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP010'), '2025-04-01',
 (SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-MORN'),
 (SELECT Id FROM attendance.AttendanceStatus WHERE StatusCode='PRESENT'),
 '2025-04-01 06:55:00', '2025-04-01 15:05:00', 0, 0, 490, 10, 0),

((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP020'), '2025-04-01',
 (SELECT Id FROM attendance.Shift WHERE ShiftCode='SHF-EMER-D'),
 (SELECT Id FROM attendance.AttendanceStatus WHERE StatusCode='PRESENT'),
 '2025-04-01 07:52:00', '2025-04-01 20:10:00', 0, 0, 730, 10, 0);

PRINT 'Inserting AttendanceLog (sample biometric punches)...';
INSERT INTO attendance.AttendanceLog (EmployeeId, PunchTime, PunchType, DeviceId, Location, IsProcessed) VALUES
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP001'), '2025-04-01 08:52:00', 'IN',  'BIO-MUM-01', 'Mumbai HQ - Main Gate',    1),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP001'), '2025-04-01 18:07:00', 'OUT', 'BIO-MUM-01', 'Mumbai HQ - Main Gate',    1),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005'), '2025-04-01 09:11:00', 'IN',  'BIO-MUM-01', 'Mumbai HQ - Main Gate',    1),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005'), '2025-04-01 18:03:00', 'OUT', 'BIO-MUM-01', 'Mumbai HQ - Main Gate',    1),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP010'), '2025-04-01 06:55:00', 'IN',  'BIO-MUM-02', 'Mumbai HQ - Ward Entrance', 1),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP010'), '2025-04-01 15:05:00', 'OUT', 'BIO-MUM-02', 'Mumbai HQ - Ward Entrance', 1),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP020'), '2025-04-01 07:52:00', 'IN',  'BIO-DEL-01', 'Delhi - Emergency Entrance', 1),
((SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP020'), '2025-04-01 20:10:00', 'OUT', 'BIO-DEL-01', 'Delhi - Emergency Entrance', 1);

PRINT 'Inserting MobileAttendanceLog (sample GPS punches)...';
INSERT INTO attendance.MobileAttendanceLog (EmployeeId, GeoFenceId, PunchTime, Latitude, Longitude, IsInsideGeoFence, DeviceInfo) VALUES
