...
INSERT INTO helpdesk.TicketCategory (Id, CategoryCode, CategoryName, Description) VALUES
(NEWID(), 'HARDWARE',        'Hardware',              'All physical device issues'),
(NEWID(), 'SOFTWARE',        'Software',              'Application and OS issues'),
(NEWID(), 'NETWORK',         'Network',               'LAN, Wi-Fi, VPN connectivity'),
(NEWID(), 'ACCESS',          'Access & Permissions',  'User access, AD, role-based permissions'),
(NEWID(), 'SECURITY',        'Security',              'Virus, phishing, data-breach incidents'),
(NEWID(), 'EMAIL',           'Email',                 'Email configuration, delivery, spam'),
(NEWID(), 'EHR_EMR',         'EHR / EMR System',      'Electronic Health Record system issues'),
(NEWID(), 'BIOMEDICAL',      'Biomedical Equipment',  'Medical device IT interface issues'),
(NEWID(), 'GENERAL',         'General IT Support',    'Miscellaneous IT requests');

-- Sub-categories (ParentCategoryId resolved by code)
INSERT INTO helpdesk.TicketCategory (Id, CategoryCode, CategoryName, ParentCategoryId, Description) VALUES
(NEWID(), 'HW_LAPTOP',       'Laptop Issue',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='HARDWARE'),
    'Laptop not booting, display, keyboard issues'),
(NEWID(), 'HW_DESKTOP',      'Desktop / Workstation',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='HARDWARE'),
    'Desktop or tower unit issues'),
(NEWID(), 'HW_PRINTER',      'Printer / Scanner',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='HARDWARE'),
    'Printing, scanning, paper-jam issues'),
(NEWID(), 'HW_PERIPHERAL',   'Peripheral Devices',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='HARDWARE'),
    'Mouse, keyboard, headset, webcam'),
(NEWID(), 'SW_OS',           'Operating System',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='SOFTWARE'),
    'Windows / Linux OS issues'),
(NEWID(), 'SW_OFFICE',       'MS Office / Productivity',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='SOFTWARE'),
    'Word, Excel, Teams, Outlook issues'),
(NEWID(), 'SW_ANTIVIRUS',    'Antivirus / EDR',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='SOFTWARE'),
    'Antivirus alerts, quarantine, updates'),
(NEWID(), 'SW_ERP',          'ERP / HRIS System',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='SOFTWARE'),
    'Payroll, HR, attendance system issues'),
(NEWID(), 'NET_WIFI',        'Wi-Fi Connectivity',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='NETWORK'),
    'Wireless network not connecting'),
(NEWID(), 'NET_LAN',         'LAN / Ethernet',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='NETWORK'),
    'Wired network and switch issues'),
(NEWID(), 'NET_VPN',         'VPN Access',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='NETWORK'),
    'Remote access VPN setup and drops'),
(NEWID(), 'ACC_AD',          'Active Directory / SSO',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='ACCESS'),
    'Password reset, account lockout'),
(NEWID(), 'ACC_APP',         'Application Access',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='ACCESS'),
    'Access to specific applications'),
(NEWID(), 'EHR_LOGIN',       'EHR Login / Access',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='EHR_EMR'),
    'EHR login failure, role mapping'),
(NEWID(), 'EHR_PERF',        'EHR Performance',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='EHR_EMR'),
    'EHR slowness, timeouts, data sync'),
(NEWID(), 'BIO_INTERFACE',   'Biomedical Integration',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='BIOMEDICAL'),
    'HL7 / DICOM interface alerts'),
(NEWID(), 'SEC_PHISH',       'Phishing / Suspicious Email',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='SECURITY'),
    'Report suspicious emails'),
(NEWID(), 'SEC_MALWARE',     'Malware / Ransomware',
    (SELECT Id FROM helpdesk.TicketCategory WHERE CategoryCode='SECURITY'),
...
INSERT INTO helpdesk.SupportGroup (Id, SupportGroupCode, SupportGroupName, DepartmentId, Description) VALUES
(NEWID(), 'DESKTOP_SUPPORT',  'Desktop Support',
    (SELECT Id FROM time.Department WHERE DepartmentCode='IT'),
    'End-user hardware and OS support'),
(NEWID(), 'APP_SUPPORT',      'Application Support',
    (SELECT Id FROM time.Department WHERE DepartmentCode='IT'),
    'ERP, EHR, productivity software support'),
(NEWID(), 'INFRA_OPS',        'IT Infrastructure & Ops',
    (SELECT Id FROM time.Department WHERE DepartmentCode='IT'),
    'Network, server, VPN and data-centre'),
(NEWID(), 'SEC_OPS',          'Security Operations',
    (SELECT Id FROM time.Department WHERE DepartmentCode='IT'),
    'Cyber-security incidents and compliance'),
(NEWID(), 'BIOMEDICAL_IT',    'Biomedical IT',
    (SELECT Id FROM time.Department WHERE DepartmentCode='IT'),
    'Medical device IT interfaces and DICOM'),
(NEWID(), 'EHR_SUPPORT',      'EHR / EMR Support',
    (SELECT Id FROM time.Department WHERE DepartmentCode='IT'),
...
INSERT INTO helpdesk.AssetCategory (Id, CategoryCode, CategoryName, IsTrackable, IsConsumable, Description) VALUES
(NEWID(), 'COMPUTE',         'Computing Devices',     1, 0, 'Laptops, desktops, servers'),
(NEWID(), 'NETWORK_HW',      'Network Hardware',      1, 0, 'Switches, routers, access points'),
(NEWID(), 'PERIPHERAL',      'Peripheral Devices',    1, 0, 'Monitors, printers, scanners'),
(NEWID(), 'MOBILE',          'Mobile Devices',        1, 0, 'Smartphones and tablets'),
(NEWID(), 'BIOMEDICAL_DEV',  'Biomedical Devices',    1, 0, 'Medical equipment with IT interface'),
(NEWID(), 'CONSUMABLE',      'Consumable Supplies',   0, 1, 'Ink cartridges, cables, batteries'),
(NEWID(), 'SERVER_HW',       'Server Hardware',       1, 0, 'Physical and rack servers'),
(NEWID(), 'SECURITY_HW',     'Security Hardware',     1, 0, 'CCTV, access-control, biometrics');

-- Sub-categories
INSERT INTO helpdesk.AssetCategory (Id, CategoryCode, CategoryName, ParentCategoryId, IsTrackable, IsConsumable, Description) VALUES
(NEWID(), 'LAPTOP',          'Laptop',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='COMPUTE'), 1, 0, 'Portable laptops'),
(NEWID(), 'DESKTOP',         'Desktop / Workstation',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='COMPUTE'), 1, 0, 'Tower or all-in-one desktops'),
(NEWID(), 'THIN_CLIENT',     'Thin Client',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='COMPUTE'), 1, 0, 'Virtual desktop thin clients'),
(NEWID(), 'SWITCH',          'Network Switch',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='NETWORK_HW'), 1, 0, 'Managed and unmanaged switches'),
(NEWID(), 'ROUTER',          'Router / Firewall',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='NETWORK_HW'), 1, 0, 'Edge routers and UTM firewalls'),
(NEWID(), 'ACCESS_POINT',    'Wireless Access Point',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='NETWORK_HW'), 1, 0, 'Wi-Fi access points'),
(NEWID(), 'MONITOR',         'Monitor / Display',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='PERIPHERAL'), 1, 0, 'LCD / LED monitors'),
(NEWID(), 'PRINTER',         'Printer / Scanner',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='PERIPHERAL'), 1, 0, 'Laser and inkjet printers'),
(NEWID(), 'PHONE_MOBILE',    'Smartphone',
...
INSERT INTO helpdesk.Vendor
    (Id, VendorCode, VendorName, ContactPerson, Email, MobileNumber, WebsiteUrl, Address)
VALUES
(NEWID(), 'VND-DELL',    'Dell Technologies India',       'Rohit Kapoor',     'rohit.kapoor@dell.com',          '9900110001', 'https://www.dell.com/en-in',        'Prestige Techpark, Marathahalli, Bengaluru 560037'),
(NEWID(), 'VND-HP',      'HP India Pvt. Ltd.',            'Sunita Menon',     'sunita.menon@hp.com',            '9900110002', 'https://www.hp.com/in-en',          'DLF IT Park, Sector 74A, Gurugram 122001'),
(NEWID(), 'VND-CISCO',   'Cisco Systems India',           'Arvind Nair',      'arvind.nair@cisco.com',          '9900110003', 'https://www.cisco.com/c/en_in',     'RMZ Infinity, Bengaluru 560016'),
(NEWID(), 'VND-LENOVO',  'Lenovo India Pvt. Ltd.',        'Priti Sharma',     'priti.sharma@lenovo.com',        '9900110004', 'https://www.lenovo.com/in/en',      'World Trade Center, Bengaluru 560001'),
(NEWID(), 'VND-MS',      'Microsoft India Pvt. Ltd.',     'Sanjay Bose',      'sanjay.bose@microsoft.com',      '9900110005', 'https://www.microsoft.com/en-in',   'Embassy Golf Links, Bengaluru 560071'),
(NEWID(), 'VND-ADOBE',   'Adobe Systems India',           'Kavita Reddy',     'kavita.reddy@adobe.com',         '9900110006', 'https://www.adobe.com/in',          'Divyasree Technopolis, Hyderabad 500081'),
(NEWID(), 'VND-ZOHO',    'Zoho Corporation Pvt. Ltd.',    'Balaji Sundaram',  'balaji.sundaram@zoho.com',       '9900110007', 'https://www.zoho.com',              'Estancia IT Park, Chennai 600044'),
(NEWID(), 'VND-AMC',     'TechCare AMC Services',         'Rajesh Patil',     'rajesh.patil@techcare.in',       '9900110008', NULL,                                '34 Kalina Road, Santacruz East, Mumbai 400055'),
(NEWID(), 'VND-DIAG',    'Diagno IT Solutions',           'Meena Iyer',       'meena.iyer@diagnoit.in',         '9900110009', NULL,                                '12 Hitech City Rd, Hyderabad 500081'),
(NEWID(), 'VND-BIOCON',  'Biocon Medical Systems',        'Girish Rao',       'girish.rao@bioconmed.in',        '9900110010', NULL,                                '78 Whitefield Main Rd, Bengaluru 560066');
...
INSERT INTO helpdesk.SlaPolicy
    (Id, PolicyCode, PolicyName, TicketPriorityCode, ResponseTimeMinutes, ResolutionTimeMinutes, EscalationTimeMinutes)
VALUES
(NEWID(), 'SLA-CRIT',   'Critical SLA',    'CRITICAL',  15,    240,    180),
(NEWID(), 'SLA-HIGH',   'High SLA',        'HIGH',      60,    480,    360),
(NEWID(), 'SLA-MED',    'Medium SLA',      'MEDIUM',    240,   1440,   1200),
(NEWID(), 'SLA-LOW',    'Low SLA',         'LOW',       480,   4320,   3600);
...
INSERT INTO helpdesk.Asset
    (Id, AssetCode, AssetTag, AssetName,
...
VALUES
-- ── Mumbai HQ Laptops ────────────────────────────────────────────────────
(NEWID(), 'AST-001', 'TAG-MUM-001', 'Dell Latitude 5540',
    ...
    'IT Manager laptop'),
(NEWID(), 'AST-002', 'TAG-MUM-002', 'HP EliteBook 840 G10',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='LAPTOP'),
    'IN_USE',
    ...
    'HR Manager laptop'),
(NEWID(), 'AST-003', 'TAG-MUM-003', 'Dell Latitude 5540',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='LAPTOP'),
    'IN_USE',
    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-DELL'),
...
(NEWID(), 'AST-004', 'TAG-MUM-004', 'Lenovo ThinkPad X1 Carbon',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='LAPTOP'),
    'IN_USE',
...
(NEWID(), 'AST-005', 'TAG-MUM-005', 'Dell OptiPlex 7010',
...
-- ── Delhi Laptops ─────────────────────────────────────────────────────────
(NEWID(), 'AST-006', 'TAG-DEL-001', 'HP EliteBook 840 G10',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='LAPTOP'),
    'IN_USE',
    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-HP'),
...
(NEWID(), 'AST-007', 'TAG-DEL-002', 'Dell Latitude 5540',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='LAPTOP'),
    'IN_USE',
    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-DELL'),
    ...
    'HR BP Delhi laptop'),
-- ── Bengaluru Laptops ─────────────────────────────────────────────────────
(NEWID(), 'AST-008', 'TAG-BLR-001', 'Lenovo ThinkPad T14',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='LAPTOP'),
    'IN_USE',
    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-LENOVO'),
...
(NEWID(), 'AST-009', 'TAG-BLR-002', 'HP EliteBook 840 G10',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='LAPTOP'),
    'IN_USE',
    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-HP'),
...
-- ── Shared / Pool Assets ─────────────────────────────────────────────────
(NEWID(), 'AST-010', 'TAG-MUM-010', 'HP LaserJet Pro 4001dn',
...
(NEWID(), 'AST-011', 'TAG-MUM-011', 'Cisco Catalyst 2960-X 24-port',
...
(NEWID(), 'AST-012', 'TAG-MUM-012', 'Cisco ISR 4321 Router',
...
(NEWID(), 'AST-013', 'TAG-MUM-013', 'Dell PowerEdge R750',
...
(NEWID(), 'AST-014', 'TAG-MUM-014', 'Dell PowerEdge R750',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='RACK_SERVER'),
    'IN_USE',
    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-DELL'),
...
(NEWID(), 'AST-015', 'TAG-MUM-015', 'Laptops – Spare Pool',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='LAPTOP'),
    'AVAILABLE',
    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-DELL'),
...
(NEWID(), 'AST-016', 'TAG-MUM-016', 'HP EliteBook 840 G8 (Repair)',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='LAPTOP'),
    'UNDER_REPAIR',
    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-HP'),
...
(NEWID(), 'AST-017', 'TAG-MUM-017', 'Dell OptiPlex 3060 (Retired)',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='DESKTOP'),
    'RETIRED',
    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-DELL'),
...
-- ── Chennai & Hyderabad ───────────────────────────────────────────────────
(NEWID(), 'AST-018', 'TAG-CHN-001', 'HP EliteBook 840 G10',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='LAPTOP'),
    'IN_USE',
    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-HP'),
...
(NEWID(), 'AST-019', 'TAG-HYD-001', 'Lenovo ThinkPad T14',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='LAPTOP'),
    'IN_USE',
    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-LENOVO'),
...
(NEWID(), 'AST-020', 'TAG-KOL-001', 'Dell Latitude 5540',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='LAPTOP'),
    'IN_USE',
    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-DELL'),
...
(NEWID(), 'AST-021', 'TAG-PUN-001', 'HP EliteBook 840 G10',
    (SELECT Id FROM helpdesk.AssetCategory WHERE CategoryCode='LAPTOP'),
    'IN_USE',
    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-HP'),
...
INSERT INTO helpdesk.AssetAssignment
    (Id, AssetId, EmployeeId, AssignedByEmployeeId, AssignedDate, Remarks, IsActive)
VALUES
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-001'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
 '2023-04-05', 'New hire allocation – IT Manager', 1),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-002'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
 '2023-06-20', 'Replacement for old laptop', 1),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-003'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP006'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
 '2023-04-05', 'Finance Manager allocation', 1),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-004'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP001'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
 '2022-11-15', 'Executive device – CMO', 1),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-005'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP014'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
 '2021-08-10', 'Admin desk workstation', 1),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-006'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP016'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
 '2023-07-05', 'Delhi Med Director laptop', 1),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-007'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP019'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
 '2023-07-05', 'HR BP Delhi laptop', 1),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-008'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP025'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
 '2023-01-20', 'Sysadmin – BLR', 1),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-009'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP021'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
 '2023-06-05', 'Bengaluru Med Director laptop', 1),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-018'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP026'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
 '2023-09-05', 'Chennai Med Director laptop', 1),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-019'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP031'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
 '2023-10-05', 'Hyderabad Med Director laptop', 1),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-020'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP036'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
 '2023-11-05', 'Kolkata Med Director laptop', 1),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-021'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP041'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
...
INSERT INTO helpdesk.AssetMaintenance
    (Id, AssetId, VendorId, MaintenanceDate, MaintenanceType, CostAmount, Description, NextMaintenanceDate, CreatedByEmployeeId)
VALUES
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-011'),
 (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-CISCO'),
 '2024-01-10', 'Preventive',    4500.00,  'Annual firmware update and port health check', '2025-01-10',
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007')),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-012'),
 (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-CISCO'),
 '2024-01-10', 'Preventive',    8000.00,  'IOS XE upgrade and routing table audit',       '2025-01-10',
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007')),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-013'),
 (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-DELL'),
 '2024-03-15', 'Preventive',   15000.00,  'RAM seat check, cooling fan replacement, ESXi patch', '2025-03-15',
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007')),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-016'),
 (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-HP'),
 '2025-03-01', 'Corrective',   12000.00,  'Screen replacement – cracked LCD panel', NULL,
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007')),
(NEWID(), (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-010'),
...
INSERT INTO helpdesk.SoftwareProduct
    (Id, SoftwareCode, SoftwareName, VersionNumber, VendorId, LicenseTypeCode, Description)
VALUES
(NEWID(), 'SW-WIN11',   'Windows 11 Pro',               '23H2',    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-MS'),    'SUBSCRIPTION', 'Microsoft Windows 11 Professional OEM/Volume'),
(NEWID(), 'SW-M365',    'Microsoft 365 Business',        'Current', (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-MS'),    'SUBSCRIPTION', 'M365 Business Standard – Teams, Office, Exchange'),
(NEWID(), 'SW-TEAMS',   'Microsoft Teams',               'Current', (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-MS'),    'SUBSCRIPTION', 'Teams standalone (bundled with M365)'),
(NEWID(), 'SW-AV',      'Microsoft Defender for Endpoint','Current',(SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-MS'),    'SUBSCRIPTION', 'EDR and antivirus for Windows endpoints'),
(NEWID(), 'SW-ADOBE',   'Adobe Acrobat Pro DC',          '2024',    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-ADOBE'), 'SUBSCRIPTION', 'PDF creation, editing and e-signatures'),
(NEWID(), 'SW-ZOHO-HR', 'Zoho People (HRIS)',            '5.0',     (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-ZOHO'),  'SUBSCRIPTION', 'HR management and payroll system'),
(NEWID(), 'SW-ZOHO-DESK','Zoho Desk',                   '5.0',     (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-ZOHO'),  'SUBSCRIPTION', 'IT helpdesk ticketing system'),
(NEWID(), 'SW-EHR',     'MedCare EHR Platform',          '4.2',     NULL,                                                          'PERPETUAL',    'In-house Electronic Health Record system'),
(NEWID(), 'SW-PACS',    'Sectra PACS',                   '24.1',    (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-BIOCON'),'PERPETUAL',    'Radiology PACS and DICOM viewer'),
(NEWID(), 'SW-VISIO',   'Microsoft Visio Plan 2',         'Current', (SELECT Id FROM helpdesk.Vendor WHERE VendorCode='VND-MS'),    'SUBSCRIPTION', 'Diagramming for IT architecture');


PRINT 'Inserting SoftwareLicense...';

INSERT INTO helpdesk.SoftwareLicense
    (Id, SoftwareProductId, LicenseKey, LicenseCount, UsedLicenseCount,
...
(NEWID(), (SELECT Id FROM helpdesk.SoftwareProduct WHERE SoftwareCode='SW-WIN11'),
...
(NEWID(), (SELECT Id FROM helpdesk.SoftwareProduct WHERE SoftwareCode='SW-M365'),
 NULL, 60, 55,
...
(NEWID(), (SELECT Id FROM helpdesk.SoftwareProduct WHERE SoftwareCode='SW-AV'),
 NULL, 60, 55,
...
(NEWID(), (SELECT Id FROM helpdesk.SoftwareProduct WHERE SoftwareCode='SW-ADOBE'),
 NULL, 10, 7,
...
(NEWID(), (SELECT Id FROM helpdesk.SoftwareProduct WHERE SoftwareCode='SW-ZOHO-HR'),
 NULL, 55, 45,
 '2024-01-01', '2025-12-31', 220000.00, 1, 1, 'All-India headcount licence'),
-- Zoho Desk – IT support team
(NEWID(), (SELECT Id FROM helpdesk.SoftwareProduct WHERE SoftwareCode='SW-ZOHO-DESK'),
 NULL, 15, 8,
 '2024-01-01', '2025-12-31', 72000.00, 1, 1, 'IT helpdesk agents across all sites'),
-- EHR Platform – perpetual enterprise
(NEWID(), (SELECT Id FROM helpdesk.SoftwareProduct WHERE SoftwareCode='SW-EHR'),
...
(NEWID(), (SELECT Id FROM helpdesk.SoftwareProduct WHERE SoftwareCode='SW-PACS'),
...
(NEWID(), (SELECT Id FROM helpdesk.SoftwareProduct WHERE SoftwareCode='SW-VISIO'),
 NULL, 3, 2,
...
INSERT INTO helpdesk.SoftwareInstallation
    (Id, SoftwareLicenseId, AssetId, InstalledForEmployeeId, InstalledByEmployeeId, InstalledDate, Remarks)
VALUES
-- Windows on all laptops
(NEWID(), (SELECT TOP 1 Id FROM helpdesk.SoftwareLicense WHERE SoftwareProductId=(SELECT Id FROM helpdesk.SoftwareProduct WHERE SoftwareCode='SW-WIN11')),
...
(NEWID(), (SELECT TOP 1 Id FROM helpdesk.SoftwareLicense WHERE SoftwareProductId=(SELECT Id FROM helpdesk.SoftwareProduct WHERE SoftwareCode='SW-WIN11')),
 ...
 '2023-04-05', 'OEM pre-installed'),
-- M365 for IT Manager
(NEWID(), (SELECT TOP 1 Id FROM helpdesk.SoftwareLicense WHERE SoftwareProductId=(SELECT Id FROM helpdesk.SoftwareProduct WHERE SoftwareCode='SW-M365')),
 (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-001'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
...
(NEWID(), (SELECT TOP 1 Id FROM helpdesk.SoftwareLicense WHERE SoftwareProductId=(SELECT Id FROM helpdesk.SoftwareProduct WHERE SoftwareCode='SW-ADOBE')),
 (SELECT Id FROM helpdesk.Asset WHERE AssetCode='AST-003'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP006'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
 '2024-06-05', 'Adobe Acrobat Pro DC – Finance team'),
-- EHR on all clinical laptops
(NEWID(), (SELECT TOP 1 Id FROM helpdesk.SoftwareLicense WHERE SoftwareProductId=(SELECT Id FROM helpdesk.SoftwareProduct WHERE SoftwareCode='SW-EHR')),
...
(NEWID(), (SELECT TOP 1 Id FROM helpdesk.SoftwareLicense WHERE SoftwareProductId=(SELECT Id FROM helpdesk.SoftwareProduct WHERE SoftwareCode='SW-PACS')),
...
INSERT INTO helpdesk.Ticket
    (Id, TicketNumber, RequesterEmployeeId, RequestedForEmployeeId,
...
INSERT INTO helpdesk.TicketComment (Id, TicketId, CommentedBy, CommentText, IsInternalComment, CreatedAt)
VALUES
-- TKT-001 comments
(NEWID(), (SELECT Id FROM helpdesk.Ticket WHERE TicketNumber='TKT-2025-001'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
...
-- TKT-002 comments
(NEWID(), (SELECT Id FROM helpdesk.Ticket WHERE TicketNumber='TKT-2025-002'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP025'),
...
-- TKT-003 comments
(NEWID(), (SELECT Id FROM helpdesk.Ticket WHERE TicketNumber='TKT-2025-003'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
...
-- TKT-004 comments
(NEWID(), (SELECT Id FROM helpdesk.Ticket WHERE TicketNumber='TKT-2025-004'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP025'),
...
-- TKT-007 comments
(NEWID(), (SELECT Id FROM helpdesk.Ticket WHERE TicketNumber='TKT-2025-007'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
...
-- TKT-008 comments
(NEWID(), (SELECT Id FROM helpdesk.Ticket WHERE TicketNumber='TKT-2025-008'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
...
-- TKT-010 comments
(NEWID(), (SELECT Id FROM helpdesk.Ticket WHERE TicketNumber='TKT-2025-010'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP025'),
...
INSERT INTO helpdesk.TicketAttachment
    (Id, TicketId, UploadedBy, FileName, OriginalFileName, FileExtension, MimeType, FileSizeInBytes, FileUrl, UploadedAt)
VALUES
(NEWID(), (SELECT Id FROM helpdesk.Ticket WHERE TicketNumber='TKT-2025-001'),
 (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'),
...
(NEWID(), (SELECT Id FROM helpdesk.Ticket WHERE TicketNumber='TKT-2025-005'),
 (SELECT Id FROM helpdesk.SlaPolicy WHERE PolicyCode='SLA-MED'),
...
(NEWID(), (SELECT Id FROM helpdesk.Ticket WHERE TicketNumber='TKT-2025-006'),
...
(NEWID(), (SELECT Id FROM helpdesk.Ticket WHERE TicketNumber='TKT-2025-009'),
 (SELECT Id FROM helpdesk.SlaPolicy WHERE PolicyCode='SLA-MED'),
