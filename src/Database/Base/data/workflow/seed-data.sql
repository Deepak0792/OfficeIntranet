...
INSERT [workflow].[WorkflowModule]
    ([Id], [ModuleCode], [ModuleName], [EntityName], [IsActive], [CreatedAt], [CreatedBy], [LastUpdatedAt], [LastUpdatedBy])
VALUES
    -- Attendance domain
    (NEWID(),   N'LEAVE_REQUEST',              N'Leave Management',               N'LeaveRequest',                1, CAST(N'2026-05-21T10:42:36.7633333' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.7633333' AS DateTime2), NULL),
    (NEWID(),   N'ATTENDANCE_REGULARIZATION',  N'Attendance Regularization',      N'AttendanceRegularization',    1, CAST(N'2026-05-21T10:42:36.7633333' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.7633333' AS DateTime2), NULL),
    (NEWID(),   N'SHIFT_SWAP_REQUEST',         N'Shift Swap',                     N'ShiftSwapRequest',            1, CAST(N'2026-05-21T10:42:36.7633333' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.7633333' AS DateTime2), NULL),
    (NEWID(),   N'COMP_OFF_REDEMPTION',        N'Comp-Off Redemption',            N'CompOffBalance',              1, CAST(N'2026-05-21T10:42:36.7633333' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.7633333' AS DateTime2), NULL),

    -- Employee domain
    (NEWID(),   N'DOCUMENT_VERIFICATION',      N'Document Verification',          N'EmployeeDocument',            1, CAST(N'2026-05-21T10:42:36.7633333' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.7633333' AS DateTime2), NULL),
    (NEWID(),   N'ADDRESS_VERIFICATION',       N'Employee Address Verification',  N'EmployeeAddress',             1, CAST(N'2026-05-27T17:04:30.3000000' AS DateTime2), NULL, CAST(N'2026-05-27T17:04:30.3000000' AS DateTime2), NULL),

    -- Payroll domain
    (NEWID(),   N'PAYROLL_CORRECTION',         N'Payroll Attendance Correction',  N'PayrollAttendanceSummary',    1, CAST(N'2026-05-21T10:42:36.7633333' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.7633333' AS DateTime2), NULL),
    (NEWID(),   N'EXPENSE_REIMBURSEMENT',      N'Expense & Reimbursement',        N'ExpenseClaim',                1, CAST(N'2026-05-21T10:42:36.7633333' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.7633333' AS DateTime2), NULL);
GO
...
VALUES
    ...
    (NEWID(),  (SELECT Id FROM workflow.WorkflowStep where WorkflowDefinitionId = (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_LEAVE_STD_V1') AND StepName = 'Department Head Approval'),  N'DESIGNATION',       NULL,    NULL, 1, 1, 1, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL),  -- Step 2: HOD (multi-designation, see Section 5)
    (NEWID(),  (SELECT Id FROM workflow.WorkflowStep where WorkflowDefinitionId = (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_LEAVE_STD_V1') AND StepName = 'HR Manager Final Approval'),  N'DESIGNATION',       NULL,    NULL,    1, 1, 1, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL),  -- Step 3: HR Manager (DesignationId 7)
    ...
    (NEWID(),  (SELECT Id FROM workflow.WorkflowStep where WorkflowDefinitionId = (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_ATTENDANCE_REG_STD_V1') AND StepName = 'HR Manager Approval'),  N'DESIGNATION',       NULL,    NULL,    1, 1, 1, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL),  -- Step 2: HR Manager (DesignationId 7)

    -- WF_SHIFT_SWAP_REQUEST_V1
    (NEWID(),  (SELECT Id FROM workflow.WorkflowStep where WorkflowDefinitionId = (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_SHIFT_SWAP_REQUEST_V1') AND StepName = 'Ward In-Charge Approval'),  N'DESIGNATION',       NULL,    NULL, 1, 1, 1, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL),  -- Step 1: Ward In-Charge
    (NEWID(),  (SELECT Id FROM workflow.WorkflowStep where WorkflowDefinitionId = (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_SHIFT_SWAP_REQUEST_V1') AND StepName = 'Scheduling Coordinator Approval'),  N'DESIGNATION',       NULL,    NULL,   1, 1, 1, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL),  -- Step 2: Scheduling Coordinator (DesignationId 10)

    -- WF_COMP_OFF_REQUEST_V1
    (NEWID(), (SELECT Id FROM workflow.WorkflowStep where WorkflowDefinitionId = (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_COMP_OFF_REQUEST_V1') AND StepName = 'Reporting Manager Approval'), N'REPORTING_MANAGER', NULL, NULL, 1, 1, 1, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL),  -- Step 1: Reporting Manager

    -- WF_TRAINING_LEAVE_V1
    (NEWID(), (SELECT Id FROM workflow.WorkflowStep where WorkflowDefinitionId = (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_TRAINING_LEAVE_V1') AND StepName = 'Department Head Approval'), N'DESIGNATION',       NULL,    NULL, 1, 1, 1, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL),  -- Step 1: HOD (multi-designation, see Section 5)
    (NEWID(), (SELECT Id FROM workflow.WorkflowStep where WorkflowDefinitionId = (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_TRAINING_LEAVE_V1') AND StepName = 'HR Manager Review'), N'DESIGNATION',       NULL,    NULL,    1, 1, 1, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL),  -- Step 2: HR Manager (DesignationId 7)
    (NEWID(), (SELECT Id FROM workflow.WorkflowStep where WorkflowDefinitionId = (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_TRAINING_LEAVE_V1') AND StepName = 'Finance Manager Cost Approval'), N'DESIGNATION',       NULL,    NULL,    1, 1, 1, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL),  -- Step 3: Finance Manager (DesignationId 9)

    -- WF_DOCUMENT_VERIFY_V1
    (NEWID(), (SELECT Id FROM workflow.WorkflowStep where WorkflowDefinitionId = (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_DOCUMENT_VERIFY_V1') AND StepName = 'HR Manager Document Verification'), N'DESIGNATION',       NULL,    NULL,    1, 1, 1, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL),  -- Step 1: HR Manager (DesignationId 7)

    -- WF_PAYROLL_CORRECTION_V1
    (NEWID(), (SELECT Id FROM workflow.WorkflowStep where WorkflowDefinitionId = (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_PAYROLL_CORRECTION_V1') AND StepName = 'HR Manager Review'), N'DESIGNATION',       NULL,    NULL,    1, 1, 1, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL),  -- Step 1: HR Manager (DesignationId 7)
    (NEWID(), (SELECT Id FROM workflow.WorkflowStep where WorkflowDefinitionId = (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_PAYROLL_CORRECTION_V1') AND StepName = 'Finance Manager Authorization'), N'DESIGNATION',       NULL,    NULL,    1, 1, 1, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.8366667' AS DateTime2), NULL),  -- Step 2: Finance Manager (DesignationId 9)
...
VALUES
    ...
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_LEAVE_STD_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'GLOBAL'), 1, CAST(N'2024-01-01' AS Date), NULL, 10, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_LEAVE_STD_V1
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_LEAVE_EMRGENCY_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'GLOBAL'), 1, CAST(N'2024-01-01' AS Date), NULL,  5, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_LEAVE_EMRGENCY_V1       (priority 5 = higher precedence)
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_ATTENDANCE_REG_STD_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'GLOBAL'), 1, CAST(N'2024-01-01' AS Date), NULL, 10, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_ATTENDANCE_REG_STD_V1
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_COMP_OFF_REQUEST_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'GLOBAL'), 1, CAST(N'2024-01-01' AS Date), NULL, 10, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_COMP_OFF_REQUEST_V1
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_TRAINING_LEAVE_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'GLOBAL'), 1, CAST(N'2024-01-01' AS Date), NULL, 10, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_TRAINING_LEAVE_V1
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_DOCUMENT_VERIFY_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'GLOBAL'), 1, CAST(N'2024-01-01' AS Date), NULL, 10, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_DOCUMENT_VERIFY_V1
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_ADDRESS_VERIFICATION_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'GLOBAL'), 1, CAST(N'2024-01-01' AS Date), NULL, 10, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_ADDRESS_VERIFICATION_V1

    -- Department-scoped assignments (ScopeTypeId 4)
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_SHIFT_SWAP_REQUEST_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'OFFICE'), 6, CAST(N'2024-01-01' AS Date), NULL, 10, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_SHIFT_SWAP_REQUEST_V1 → Dept 6
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_SHIFT_SWAP_REQUEST_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'OFFICE'), 5, CAST(N'2024-01-01' AS Date), NULL, 10, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_SHIFT_SWAP_REQUEST_V1 → Dept 5

    -- Legal Entity-scoped assignment (ScopeTypeId 3)
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_PAYROLL_CORRECTION_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'LEGAL_ENTITY'), 1, CAST(N'2024-01-01' AS Date), NULL, 10, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL);  -- WF_PAYROLL_CORRECTION_V1
...
VALUES
    ...
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_LEAVE_STD_V1'), (SELECT Id FROM workflow.WorkflowModule where ModuleCode = 'LEAVE_REQUEST'), 101, NULL,    N'IN_PROGRESS', NEWID(),  CAST(N'2025-04-28T09:15:00.0000000' AS DateTime2), NULL,                                         NULL),  -- Leave: at HOD step
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_ATTENDANCE_REG_STD_V1'), (SELECT Id FROM workflow.WorkflowModule where ModuleCode = 'ATTENDANCE_REGULARIZATION'), 201, NULL,    N'PENDING', NEWID(), CAST(N'2025-04-30T10:00:00.0000000' AS DateTime2), NULL,                                         NULL),  -- Attendance Reg: awaiting manager
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_SHIFT_SWAP_REQUEST_V1'), (SELECT Id FROM workflow.WorkflowModule where ModuleCode = 'SHIFT_SWAP_REQUEST'), 301, NULL,    N'IN_PROGRESS', NEWID(),  CAST(N'2025-04-27T14:30:00.0000000' AS DateTime2), NULL,                                         NULL),  -- Shift Swap: at coordinator step
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_COMP_OFF_REQUEST_V1'), (SELECT Id FROM workflow.WorkflowModule where ModuleCode = 'COMP_OFF_REDEMPTION'), 501, NULL,   N'PENDING',     NEWID(), CAST(N'2025-05-01T08:00:00.0000000' AS DateTime2), NULL,                                         NULL),  -- Comp-Off: awaiting manager
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_PAYROLL_CORRECTION_V1'), (SELECT Id FROM workflow.WorkflowModule where ModuleCode = 'PAYROLL_CORRECTION'), 901, NULL,   N'IN_PROGRESS', NEWID(),  CAST(N'2025-05-02T09:00:00.0000000' AS DateTime2), NULL,                                         NULL),  -- Payroll Correction: at finance step

    -- Completed instances
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_LEAVE_EMRGENCY_V1'), (SELECT Id FROM workflow.WorkflowModule where ModuleCode = 'LEAVE_REQUEST'), 102, NULL, N'APPROVED',   NEWID() ,  CAST(N'2025-04-29T06:45:00.0000000' AS DateTime2), CAST(N'2025-04-29T08:10:00.0000000' AS DateTime2), NULL),  -- Emergency Leave: fast-track approved
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_DOCUMENT_VERIFY_V1'), (SELECT Id FROM workflow.WorkflowModule where ModuleCode = 'DOCUMENT_VERIFICATION'), 801, NULL, N'APPROVED',    NEWID(),  CAST(N'2025-04-15T10:30:00.0000000' AS DateTime2), CAST(N'2025-04-16T14:00:00.0000000' AS DateTime2), NULL),  -- Document Verification: approved
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_LEAVE_STD_V1'), (SELECT Id FROM workflow.WorkflowModule where ModuleCode = 'LEAVE_REQUEST'), 103, NULL, N'APPROVED',    NEWID(), CAST(N'2025-04-10T08:00:00.0000000' AS DateTime2), CAST(N'2025-04-14T17:00:00.0000000' AS DateTime2), NULL),  -- Leave (full 3-step): approved

    -- Terminated instances
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_SHIFT_SWAP_REQUEST_V1'), (SELECT Id FROM workflow.WorkflowModule where ModuleCode = 'SHIFT_SWAP_REQUEST'), 302, NULL, N'CANCELLED',   NEWID(), CAST(N'2025-04-22T13:00:00.0000000' AS DateTime2), CAST(N'2025-04-22T15:30:00.0000000' AS DateTime2), NULL),  -- Shift Swap: cancelled by requester
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_ATTENDANCE_REG_STD_V1'), (SELECT Id FROM workflow.WorkflowModule where ModuleCode = 'ATTENDANCE_REGULARIZATION'), 202, NULL, N'REJECTED',    NEWID(), CAST(N'2025-04-18T09:00:00.0000000' AS DateTime2), CAST(N'2025-04-19T11:00:00.0000000' AS DateTime2), NULL);  -- Attendance Reg: rejected (no proof)
