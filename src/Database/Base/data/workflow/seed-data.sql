...
VALUES
    ...
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_LEAVE_STD_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'GLOBAL'), NULL, CAST(N'2024-01-01' AS Date), NULL, 10, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_LEAVE_STD_V1
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_LEAVE_EMRGENCY_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'GLOBAL'), NULL, CAST(N'2024-01-01' AS Date), NULL,  5, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_LEAVE_EMRGENCY_V1       (priority 5 = higher precedence)
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_ATTENDANCE_REG_STD_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'GLOBAL'), NULL, CAST(N'2024-01-01' AS Date), NULL, 10, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_ATTENDANCE_REG_STD_V1
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_COMP_OFF_REQUEST_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'GLOBAL'), NULL, CAST(N'2024-01-01' AS Date), NULL, 10, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_COMP_OFF_REQUEST_V1
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_TRAINING_LEAVE_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'GLOBAL'), NULL, CAST(N'2024-01-01' AS Date), NULL, 10, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_TRAINING_LEAVE_V1
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_DOCUMENT_VERIFY_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'GLOBAL'), NULL, CAST(N'2024-01-01' AS Date), NULL, 10, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_DOCUMENT_VERIFY_V1
    (NEWID(), (SELECT Id FROM workflow.WorkflowDefinition where WorkflowCode = 'WF_ADDRESS_VERIFICATION_V1'), (SELECT Id FROM time.ScopeType WHERE ScopeCode = 'GLOBAL'), NULL, CAST(N'2024-01-01' AS Date), NULL, 10, 1, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL, CAST(N'2026-05-21T10:42:36.9100000' AS DateTime2), NULL),  -- WF_ADDRESS_VERIFICATION_V1
