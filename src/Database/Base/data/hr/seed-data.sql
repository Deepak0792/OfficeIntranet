...
INSERT INTO hr.InterviewRound (Id, RoundNumber, RoundCode, RoundName, Description, InterviewType, IsMandatory, DisplayOrder) VALUES
(NEWID(), 1, 'HR_SCREEN',    'HR Screening',             'Initial HR fitment and culture check',                             'PHONE_SCREEN',      1, 1),
(NEWID(), 2, 'TECH_1',       'Technical Round 1',        'Core technical or clinical knowledge assessment',                  'VIDEO_CALL',      1, 2),
(NEWID(), 3, 'TECH_2',       'Technical Round 2',        'Advanced technical depth or case-based assessment',                'VIDEO_CALL',      0, 3),
(NEWID(), 4, 'DOMAIN_EXPERT','Domain Expert Review',     'Specialist domain evaluation by senior clinician or lead',         'IN_PERSON', 0, 4),
(NEWID(), 5, 'MANAGER',      'Hiring Manager Round',     'Evaluation by direct reporting manager',                           'IN_PERSON', 1, 5),
(NEWID(), 6, 'PANEL',        'Panel Interview',          'Cross-functional panel assessment for senior roles',               'PANEL',     0, 6),
(NEWID(), 7, 'FINAL_HR',     'Final HR & Offer',         'Compensation discussion and offer formulation',                    'IN_PERSON', 1, 7);


PRINT 'Inserting hr.PanelRole...';
INSERT INTO hr.PanelRole (Id, RoleCode, RoleName, Description, CanSubmitFeedback, DisplayOrder) VALUES
(NEWID(), 'PANEL_LEAD',      'Panel Lead',           'Leads the panel and consolidates feedback',         1, 1),
(NEWID(), 'INTERVIEWER',     'Interviewer',          'Core interviewer responsible for primary questions', 1, 2),
(NEWID(), 'TECH_EXPERT',     'Technical Expert',     'Assesses technical or clinical depth',              1, 3),
(NEWID(), 'DOMAIN_EXPERT',   'Domain Expert',        'Evaluates domain-specific knowledge',               1, 4),
(NEWID(), 'HR_COORD',        'HR Coordinator',       'Facilitates process and covers HR fitment',         1, 5),
(NEWID(), 'OBSERVER',        'Observer',             'Shadows the interview for calibration or training',  0, 6),
(NEWID(), 'NOTE_TAKER',      'Note Taker',           'Records interview proceedings',                     0, 7);


PRINT 'Inserting hr.JobPosting...';
INSERT INTO hr.JobPosting (Id, Title, DepartmentId, DesignationId, LocationId, LegalEntityId, EmploymentType, ExperienceMinYrs, ExperienceMaxYrs, SalaryMin, SalaryMax, 
...
INSERT INTO hr.Candidate (Id, FirstName, MiddleName, LastName, Email, Phone, DateOfBirth, Gender, CurrentCompany, CurrentTitle, TotalExpYrs, NoticePeriodDays, CurrentSalary, CurrencyCode, LinkedInUrl, ResumeUrl, Source, ReferredByEmployeeId) VALUES
(NEWID(), 'Poornima',    NULL,       'Hegde',        'poornima.hegde@gmail.com',         '9845100201', '1992-05-14', 'Female',   'Manipal Hospitals',        'Senior Nurse ICU',         7.0,  30,  720000.00,  'INR', 'https://linkedin.com/in/poornimahegde',     'https://storage.medcareindia.com/resumes/poornima_hegde.pdf',     'LinkedIn',  NULL),
(NEWID(), 'Siddharth',   NULL,       'Joshi',        'siddharth.joshi@gmail.com',        '9920100202', '1997-11-03', 'Male',     'Kokilaben Hospital',       'Junior Resident',          2.0,  15,  550000.00,  'INR', 'https://linkedin.com/in/siddharthjoshi',    'https://storage.medcareindia.com/resumes/siddharth_joshi.pdf',    'JobPortal', NULL),
(NEWID(), 'Nandita',     'Rao',      'Krishnamurthy','nandita.krishnamurthy@gmail.com',  '9886100203', '1995-07-22', 'Female',   'Apollo Hospitals',         'HR Executive',             4.0,  30,  480000.00,  'INR', NULL,                                        'https://storage.medcareindia.com/resumes/nandita_krishnamurthy.pdf','Referral',  (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP021')),
(NEWID(), 'Abhijit',     NULL,       'Pawar',        'abhijit.pawar@gmail.com',          '9823100204', '1991-03-08', 'Male',     'Cipla Ltd.',               'Clinical Pharmacist',      6.5,  60,  620000.00,  'INR', 'https://linkedin.com/in/abhijitpawar',      'https://storage.medcareindia.com/resumes/abhijit_pawar.pdf',      'LinkedIn',  NULL),
(NEWID(), 'Rashida',     NULL,       'Shaikh',       'rashida.shaikh@gmail.com',         '9849100205', '1993-09-17', 'Female',   'Max Healthcare',           'Systems Administrator',    5.0,  45,  560000.00,  'INR', 'https://linkedin.com/in/rashidashaikh',     'https://storage.medcareindia.com/resumes/rashida_shaikh.pdf',     'JobPortal', NULL),
(NEWID(), 'Kiran',       NULL,       'Bhat',         'kiran.bhat@gmail.com',             '9845100206', '1990-12-25', 'Male',     'Fortis Healthcare',        'Senior Staff Nurse ICU',   9.0,  30,  850000.00,  'INR', 'https://linkedin.com/in/kiranbhat',         'https://storage.medcareindia.com/resumes/kiran_bhat.pdf',         'LinkedIn',  NULL),
(NEWID(), 'Trisha',      NULL,       'Nambiar',      'trisha.nambiar@gmail.com',         '9446100207', '1994-04-11', 'Female',   NULL,                       NULL,                       1.5,  0,   NULL,       'INR', NULL,                                        'https://storage.medcareindia.com/resumes/trisha_nambiar.pdf',     'CampusDrive',NULL);

PRINT 'Inserting hr.Application...';
INSERT INTO hr.Application (Id, JobPostingId, CandidateId, ApplicationStatus, ReviewedByEmployeeId, AppliedAt, StatusUpdatedAt) VALUES
...
INSERT INTO hr.ApplicationStatusHistory (Id, ApplicationId, FromStatus, ToStatus, ChangedByEmployeeId, Remarks, ChangedAt) VALUES
(NEWID(), (SELECT Id FROM hr.Application WHERE CandidateId=(SELECT Id FROM hr.Candidate WHERE Email='siddharth.joshi@gmail.com')), NULL,        'APPLIED',   (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005'), 'Application received via job portal', '2025-02-20 14:00:00'),
(NEWID(), (SELECT Id FROM hr.Application WHERE CandidateId=(SELECT Id FROM hr.Candidate WHERE Email='siddharth.joshi@gmail.com')), 'APPLIED',   'SCREENING', (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005'), 'Shortlisted; HR screen call done',    '2025-02-25 10:00:00'),
(NEWID(), (SELECT Id FROM hr.Application WHERE CandidateId=(SELECT Id FROM hr.Candidate WHERE Email='siddharth.joshi@gmail.com')), 'SCREENING', 'INTERVIEW', (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005'), 'Cleared screening; technical round',  '2025-03-05 11:00:00'),
(NEWID(), (SELECT Id FROM hr.Application WHERE CandidateId=(SELECT Id FROM hr.Candidate WHERE Email='siddharth.joshi@gmail.com')), 'INTERVIEW', 'OFFER',     (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005'), 'Cleared technical; offer in progress','2025-03-25 10:00:00');

-- Trisha Nambiar pipeline
INSERT INTO hr.ApplicationStatusHistory (Id, ApplicationId, FromStatus, ToStatus, ChangedByEmployeeId, Remarks, ChangedAt) VALUES
(NEWID(), (SELECT Id FROM hr.Application WHERE CandidateId=(SELECT Id FROM hr.Candidate WHERE Email='trisha.nambiar@gmail.com')), NULL,      'APPLIED',   (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005'), 'Application received',                            '2025-03-01 10:00:00'),
(NEWID(), (SELECT Id FROM hr.Application WHERE CandidateId=(SELECT Id FROM hr.Candidate WHERE Email='trisha.nambiar@gmail.com')), 'APPLIED', 'REJECTED',  (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005'), 'Insufficient clinical experience for the role',   '2025-03-12 14:00:00');

PRINT 'Inserting hr.InterviewRoundConfig...';
-- Senior Staff Nurse ICU - 4 rounds
INSERT INTO hr.InterviewRoundConfig (Id, JobPostingId, InterviewRoundId, InterviewType, DurationMins, IsMandatory) VALUES
(NEWID(), (SELECT Id FROM hr.JobPosting WHERE Title='Senior Staff Nurse - ICU'), (SELECT Id FROM hr.InterviewRound WHERE RoundCode='HR_SCREEN'),    'PHONE_SCREEN',      30,  1),
(NEWID(), (SELECT Id FROM hr.JobPosting WHERE Title='Senior Staff Nurse - ICU'), (SELECT Id FROM hr.InterviewRound WHERE RoundCode='TECH_1'),       'VIDEO_CALL',      60,  1),
(NEWID(), (SELECT Id FROM hr.JobPosting WHERE Title='Senior Staff Nurse - ICU'), (SELECT Id FROM hr.InterviewRound WHERE RoundCode='MANAGER'),      'IN_PERSON',  45,  1),
(NEWID(), (SELECT Id FROM hr.JobPosting WHERE Title='Senior Staff Nurse - ICU'), (SELECT Id FROM hr.InterviewRound WHERE RoundCode='FINAL_HR'),     'IN_PERSON',  30,  1);

-- Resident Doctor Cardiology - 3 rounds
INSERT INTO hr.InterviewRoundConfig (Id, JobPostingId, InterviewRoundId, InterviewType, DurationMins, IsMandatory) VALUES
(NEWID(), (SELECT Id FROM hr.JobPosting WHERE Title='Resident Doctor - Cardiology'), (SELECT Id FROM hr.InterviewRound WHERE RoundCode='HR_SCREEN'),    'PHONE_SCREEN',      30,  1),
(NEWID(), (SELECT Id FROM hr.JobPosting WHERE Title='Resident Doctor - Cardiology'), (SELECT Id FROM hr.InterviewRound WHERE RoundCode='TECH_1'),       'VIDEO_CALL',      60,  1),
(NEWID(), (SELECT Id FROM hr.JobPosting WHERE Title='Resident Doctor - Cardiology'), (SELECT Id FROM hr.InterviewRound WHERE RoundCode='DOMAIN_EXPERT'),'IN_PERSON',  60,  1);

-- Systems Administrator Delhi - 3 rounds
INSERT INTO hr.InterviewRoundConfig (Id, JobPostingId, InterviewRoundId, InterviewType, DurationMins, IsMandatory) VALUES
(NEWID(), (SELECT Id FROM hr.JobPosting WHERE Title='Systems Administrator - EHR & Network'), (SELECT Id FROM hr.InterviewRound WHERE RoundCode='HR_SCREEN'), 'PHONE_SCREEN',  30, 1),
(NEWID(), (SELECT Id FROM hr.JobPosting WHERE Title='Systems Administrator - EHR & Network'), (SELECT Id FROM hr.InterviewRound WHERE RoundCode='TECH_1'),    'VIDEO_CALL',  90, 1),
(NEWID(), (SELECT Id FROM hr.JobPosting WHERE Title='Systems Administrator - EHR & Network'), (SELECT Id FROM hr.InterviewRound WHERE RoundCode='MANAGER'),   'IN_PERSON', 45, 1);


PRINT 'Inserting hr.Interview...';
-- Poornima Hegde - HR Screen (completed)
INSERT INTO hr.Interview (Id, ApplicationId, InterviewRoundConfigId, ScheduledAt, DurationMins, InterviewStatus, CreatedBy) VALUES
(
    NEWID(), 
...
INSERT INTO hr.Interview (Id, ApplicationId, InterviewRoundConfigId, ScheduledAt, DurationMins, Venue, InterviewStatus, CreatedBy) VALUES
(
    NEWID(), 
    (SELECT Id FROM hr.Application WHERE CandidateId=(SELECT Id FROM hr.Candidate WHERE Email='poornima.hegde@gmail.com') AND JobPostingId=(SELECT Id FROM hr.JobPosting WHERE Title='Senior Staff Nurse - ICU')),
...
INSERT INTO hr.InterviewPanel (Id, InterviewId, InterviewerEmployeeId, PanelRoleId, InterviewPurpose, EvaluationTopics, IsLead, CanSubmitFeedback, ConfirmedAt) VALUES
(
    NEWID(), 
...
INSERT INTO hr.InterviewFeedback (Id, InterviewPanelId, OverallRating, TechnicalScore, CommunicationScore, CulturalFitScore, PurposeSpecificScore, Strengths, Concerns, RecommendationStatus, AdditionalNotes, SubmittedAt) VALUES
(
    NEWID(), (SELECT Id FROM hr.InterviewPanel WHERE InterviewerEmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP004') AND InterviewPurpose ='CLINICAL_KNOWLEDGE'),
    8.5, 9.0, 8.0, 8.5, 9.0,
...
INSERT INTO hr.InterviewFeedback (Id, InterviewPanelId, OverallRating, TechnicalScore, CommunicationScore, CulturalFitScore, PurposeSpecificScore, Strengths, Concerns, RecommendationStatus, AdditionalNotes, SubmittedAt) VALUES
(
    NEWID(), (SELECT Id FROM hr.InterviewPanel WHERE InterviewerEmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP010') AND InterviewPurpose = 'PROBLEM_SOLVING'),
    8.0, 8.0, 8.5, 8.0, 7.5,
...
INSERT INTO hr.InterviewFeedback (Id, InterviewPanelId, OverallRating, TechnicalScore, CommunicationScore, CulturalFitScore, PurposeSpecificScore, Strengths, Concerns, RecommendationStatus, AdditionalNotes, SubmittedAt) VALUES
(
    NEWID(), (SELECT Id FROM hr.InterviewPanel WHERE InterviewerEmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP042') AND InterviewPurpose = 'CLINICAL_KNOWLEDGE'),
    7.5, 7.5, 8.0, 8.0, 7.5,
...
INSERT INTO hr.InterviewFeedback (Id, InterviewPanelId, OverallRating, TechnicalScore, CommunicationScore, CulturalFitScore, PurposeSpecificScore, Strengths, Concerns, RecommendationStatus, AdditionalNotes, SubmittedAt) VALUES
(
    NEWID(), (SELECT Id FROM hr.InterviewPanel WHERE InterviewerEmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007') AND InterviewPurpose = 'TECHNICAL_DEPTH'),
    7.0, 7.5, 7.0, 7.0, 7.5,
...
INSERT INTO hr.InterviewFeedback (Id, InterviewPanelId, OverallRating, TechnicalScore, CommunicationScore, CulturalFitScore, PurposeSpecificScore, Strengths, Concerns, RecommendationStatus, AdditionalNotes, SubmittedAt) VALUES
(
    NEWID(), (SELECT Id FROM hr.InterviewPanel WHERE InterviewerEmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP025') AND InterviewPurpose = 'PROBLEM_SOLVING'),
    7.5, 7.0, 7.5, 7.5, 7.0,
...
INSERT INTO hr.PackageNegotiation (Id, ApplicationId, HREmployeeId, RoundNumber, OfferedCTC, CandidateAsk, FinalCTC, CurrencyCode, VariablePct, JoiningBonus, OtherBenefits, NegotiationStatus, Notes, NegotiatedAt) VALUES
(
    NEWID(), 
    (SELECT Id FROM hr.Application WHERE CandidateId=(SELECT Id FROM hr.Candidate WHERE Email='poornima.hegde@gmail.com') AND JobPostingId=(SELECT Id FROM hr.JobPosting WHERE Title='Senior Staff Nurse - ICU')),
    (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005'),
...
INSERT INTO hr.OfferLetter (Id, ApplicationId, PackageNegotiationId, LetterFileUrl, IssuedDate, ExpiryDate, OfferedPosition, ProposedJoiningDate, OfferStatus, AcceptedAt, IssuedByEmployeeId) VALUES
(
    NEWID(), 
    (SELECT Id FROM hr.Application WHERE CandidateId=(SELECT Id FROM hr.Candidate WHERE Email='poornima.hegde@gmail.com') AND JobPostingId=(SELECT Id FROM hr.JobPosting WHERE Title='Senior Staff Nurse - ICU')),
...
INSERT INTO hr.OnboardingChecklist (Id, ChecklistName, Phase, EmploymentType) VALUES
(NEWID(), 'Full-Time Clinical Staff - Pre-Onboarding',       'PRE_ONBOARDING',   'FULL_TIME'),
(NEWID(), 'Full-Time Clinical Staff - Day One',              'DAY_ONE',          'FULL_TIME'),
(NEWID(), 'Full-Time Clinical Staff - First Week',           'FIRST_WEEK',       'FULL_TIME'),
(NEWID(), 'Full-Time Clinical Staff - Post-Onboarding',      'POST_ONBOARDING',  'FULL_TIME'),
(NEWID(), 'Full-Time Admin / Support Staff - Pre-Onboarding','PRE_ONBOARDING',   'FULL_TIME'),
(NEWID(), 'Full-Time Admin / Support Staff - Day One',       'DAY_ONE',          'FULL_TIME'),
(NEWID(), 'Junior Resident / Intern - Pre-Onboarding',       'PRE_ONBOARDING',   'FULL_TIME');


PRINT 'Inserting hr.OnboardingChecklistItem...';
-- Clinical Pre-Onboarding
INSERT INTO hr.OnboardingChecklistItem (Id, OnboardingChecklistId, TaskName, Description, OwnerRole, DisplayOrder, IsMandatory) VALUES
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - Pre-Onboarding'), 'Collect signed offer letter',          'Obtain candidate-signed copy of the offer letter',                                     'HR',       1,  1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - Pre-Onboarding'), 'Verify Medical License / MCI Reg.',    'Validate MCI or State Medical Council registration number',                            'HR',       2,  1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - Pre-Onboarding'), 'Collect Aadhaar and PAN copies',       'Collect self-attested copies of government IDs',                                       'HR',       3,  1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - Pre-Onboarding'), 'Collect educational certificates',     'Degree, diploma, and internship completion certificates',                              'HR',       4,  1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - Pre-Onboarding'), 'Collect experience/relieving letter',  'Previous employer relieving letter or experience certificate',                         'HR',       5,  0),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - Pre-Onboarding'), 'Collect bank account details',         'Cancelled cheque or bank passbook copy for salary credit',                             'HR',       6,  1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - Pre-Onboarding'), 'Initiate BGV - Identity & Education',  'Raise background verification request with agency for identity and education checks',  'HR',       7,  1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - Pre-Onboarding'), 'COVID-19 vaccination certificate',     'Collect proof of full COVID-19 vaccination',                                           'HR',       8,  1);

-- Clinical Day One
INSERT INTO hr.OnboardingChecklistItem (Id, OnboardingChecklistId, TaskName, Description, OwnerRole, DisplayOrder, IsMandatory) VALUES
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - Day One'), 'Issue employee ID card',               'Generate and issue photo ID badge with department and floor access',   'HR',       1,  1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - Day One'), 'Create EHR system login',             'Provision EHR (hospital system) credentials with correct role',         'IT',       2,  1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - Day One'), 'Register biometric at device',        'Enrol fingerprint on floor biometric device',                           'IT',       3,  1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - Day One'), 'HR induction session',                'Attend mandatory HR induction covering policies and benefits',          'HR',       4,  1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - Day One'), 'Introduction to reporting manager',   'Formal introduction and department orientation by reporting manager',   'Manager',  5,  1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - Day One'), 'Collect uniform and equipment',       'Issue hospital scrubs, stethoscope (where applicable), and locker',    'Admin',    6,  1);

-- Clinical First Week
INSERT INTO hr.OnboardingChecklistItem (Id, OnboardingChecklistId, TaskName, Description, OwnerRole, DisplayOrder, IsMandatory) VALUES
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - First Week'), 'Complete infection control training',      'Mandatory online module on hospital infection prevention and PPE',              'HR',       1,  1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - First Week'), 'Complete BLS refresher (if lapsed)',        'Basic Life Support recertification if certificate is older than 2 years',        'Training', 2,  0),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - First Week'), 'Shadow senior for department orientation',  'Spend first 2 days shadowing assigned senior staff',                           'Manager',  3,  1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - First Week'), 'Review patient safety and escalation SOPs', 'Read and acknowledge department-specific SOPs',                                 'Manager',  4,  1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Clinical Staff - First Week'), 'Complete HRMS self-service setup',          'Employee to update profile, upload photo, and review leave balance in HRMS',    'Employee', 5,  1);

-- Admin / Support Pre-Onboarding
INSERT INTO hr.OnboardingChecklistItem (Id, OnboardingChecklistId, TaskName, Description, OwnerRole, DisplayOrder, IsMandatory) VALUES
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Admin / Support Staff - Pre-Onboarding'), 'Collect signed offer letter',      'Obtain candidate-signed copy of the offer letter',                     'HR',  1, 1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Admin / Support Staff - Pre-Onboarding'), 'Collect Aadhaar and PAN copies',   'Collect self-attested government ID copies',                           'HR',  2, 1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Admin / Support Staff - Pre-Onboarding'), 'Collect educational certificates',  'Degree and diploma certificates relevant to the role',                 'HR',  3, 1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Admin / Support Staff - Pre-Onboarding'), 'Collect bank account details',     'Cancelled cheque for salary credit setup',                             'HR',  4, 1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Admin / Support Staff - Pre-Onboarding'), 'Initiate BGV - Employment History','Raise BGV request for employment history and identity verification',  'HR',  5, 1);

-- Admin Day One
INSERT INTO hr.OnboardingChecklistItem (Id, OnboardingChecklistId, TaskName, Description, OwnerRole, DisplayOrder, IsMandatory) VALUES
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Admin / Support Staff - Day One'), 'Issue employee ID card',           'Generate and issue photo ID with office access',                   'HR',       1, 1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Admin / Support Staff - Day One'), 'Create system/application login',  'Provision email, HRMS, and relevant application access',           'IT',       2, 1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Admin / Support Staff - Day One'), 'Register biometric at device',    'Enrol fingerprint on main entrance biometric device',              'IT',       3, 1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Admin / Support Staff - Day One'), 'HR induction session',            'Attend HR induction covering code of conduct and IT policies',     'HR',       4, 1),
(NEWID(), (SELECT Id FROM hr.OnboardingChecklist WHERE ChecklistName='Full-Time Admin / Support Staff - Day One'), 'Workstation and asset allocation', 'Allocate laptop/desktop, headset, and stationery',                'IT',       5, 1);
...
INSERT INTO hr.DocumentVerification (Id, EmployeeId, DocumentTypeId, OnboardingPhase, FileUrl, DocumentNumber, IssuedBy, IssueDate, ExpiryDate, DocVerifyStatus, SubmittedDate, VerifiedDate, VerifiedByEmployeeId, Remarks) VALUES
...
(NEWID(), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP034'), (SELECT Id FROM time.DocumentType WHERE DocumentTypeCode='COVIDVACC'),   'PRE_ONBOARDING', NULL,                                                              NULL,             NULL,                   NULL,         NULL,         'PENDING',      NULL,         NULL,         NULL,                                                 'COVID vaccination certificate not yet submitted - follow up with employee');


PRINT 'Inserting hr.BGVAgency...';
INSERT INTO hr.BGVAgency (Id, AgencyName, ContactPerson, Email, Phone) VALUES
(NEWID(), 'AuthBridge Research Services Pvt. Ltd.',  'Rajat Sharma',     'rajat.sharma@authbridge.com',      '+91-124-4399999'),
(NEWID(), 'First Advantage India',                   'Preethi Nair',     'preethi.nair@fadv.com',            '+91-80-67001000'),
(NEWID(), 'Netrika Consulting India Pvt. Ltd.',      'Sundeep Malhotra', 'sundeep@netrika.com',              '+91-11-45151515'),
(NEWID(), 'IDfy Technologies Pvt. Ltd.',             'Ananya Kapoor',    'ananya.kapoor@idfy.com',           '+91-22-62662666');


PRINT 'Inserting hr.BackgroundVerification...';
INSERT INTO hr.BackgroundVerification (Id, EmployeeId, BGVAgencyId, BGVCheckType, OnboardingPhase, InitiatedByEmployeeId, InitiatedDate, ExpectedDate, CompletedDate, BGVStatus, BGVResult, Findings, ReportUrl) VALUES
...
(NEWID(), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP043'),
...
(NEWID(), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP034'),
...
(NEWID(), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP040'),
...
INSERT INTO hr.PolicyCategory (Id, CategoryCode, CategoryName, Description) VALUES
(NEWID(), 'HR_POLICY',       'HR Policies',              'Leave, attendance, code of conduct, and employee welfare policies'),
(NEWID(), 'CLINICAL_POLICY', 'Clinical & Patient Safety','Infection control, patient safety, medication administration policies'),
(NEWID(), 'IT_POLICY',       'IT & Data Security',       'EHR usage, data privacy, device management, and cybersecurity policies'),
(NEWID(), 'FINANCE_POLICY',  'Finance & Compliance',     'Expense claims, reimbursement, payroll, and statutory compliance policies'),
(NEWID(), 'OPERATIONS',      'Operations & Facilities',  'Housekeeping, bio-medical waste, transport, and facility management policies');


PRINT 'Inserting hr.PolicyDocument...';
INSERT INTO hr.PolicyDocument (Id, PolicyCategoryId, PolicyCode, PolicyName, Description, ScopeTypeId, ScopeReferenceId, AcknowledgementRequired, AcknowledgementDeadlineDays, IsActive, CreatedBy) VALUES
(
    NEWID(), 
...
INSERT INTO hr.PolicyVersion (Id, PolicyDocumentId, VersionNumber, VersionLabel, FileUrl, OriginalFileName, ChangeNotes, PolicyStatus, EffectiveDate, PublishedByEmployeeId, PublishedAt) VALUES
...
INSERT INTO hr.PolicyAcknowledgement (Id, PolicyVersionId, EmployeeId, AckStatus, DeadlineDate, AcknowledgedAt) VALUES
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-HR-001') AND VersionNumber=2), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP001'), 'ACKNOWLEDGED', '2023-01-31', '2023-01-15 09:30:00'),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-HR-001') AND VersionNumber=2), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP002'), 'ACKNOWLEDGED', '2023-01-31', '2023-01-16 10:00:00'),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-HR-001') AND VersionNumber=2), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP003'), 'ACKNOWLEDGED', '2023-01-31', '2023-01-18 11:00:00'),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-HR-001') AND VersionNumber=2), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP004'), 'ACKNOWLEDGED', '2023-01-31', '2023-01-17 14:00:00'),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-HR-001') AND VersionNumber=2), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP010'), 'ACKNOWLEDGED', '2023-01-31', '2023-01-20 09:00:00'),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-HR-001') AND VersionNumber=2), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP030'), 'ACKNOWLEDGED', '2023-03-31', '2023-03-10 10:00:00'),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-HR-001') AND VersionNumber=2), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP034'), 'PENDING',      '2023-02-15', NULL),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-HR-001') AND VersionNumber=2), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP043'), 'ACKNOWLEDGED', '2023-08-31', '2023-08-10 09:00:00');

-- Infection Control Policy v2 - clinical staff
INSERT INTO hr.PolicyAcknowledgement (Id, PolicyVersionId, EmployeeId, AckStatus, DeadlineDate, AcknowledgedAt) VALUES
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-CLN-001') AND VersionNumber=2), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP003'), 'ACKNOWLEDGED', '2022-01-08', '2022-01-05 10:00:00'),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-CLN-001') AND VersionNumber=2), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP004'), 'ACKNOWLEDGED', '2022-01-08', '2022-01-06 09:00:00'),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-CLN-001') AND VersionNumber=2), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP008'), 'ACKNOWLEDGED', '2022-01-08', '2022-01-07 11:00:00'),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-CLN-001') AND VersionNumber=2), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP010'), 'ACKNOWLEDGED', '2022-01-08', '2022-01-05 14:00:00'),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-CLN-001') AND VersionNumber=2), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP011'), 'ACKNOWLEDGED', '2022-01-08', '2022-01-07 15:00:00'),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-CLN-001') AND VersionNumber=2), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP020'), 'ACKNOWLEDGED', '2022-01-08', '2022-01-06 16:00:00'),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-CLN-001') AND VersionNumber=2), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP027'), 'ACKNOWLEDGED', '2022-01-08', '2022-01-08 09:30:00');

-- EHR Data Privacy Policy - IT and admin staff
INSERT INTO hr.PolicyAcknowledgement (Id, PolicyVersionId, EmployeeId, AckStatus, DeadlineDate, AcknowledgedAt) VALUES
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-IT-001') AND VersionNumber=1), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'), 'ACKNOWLEDGED', '2021-04-15', '2021-04-03 10:00:00'),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-IT-001') AND VersionNumber=1), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP025'), 'ACKNOWLEDGED', '2021-04-15', '2021-04-08 11:00:00'),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-IT-001') AND VersionNumber=1), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP014'), 'ACKNOWLEDGED', '2021-04-15', '2021-04-10 14:00:00'),
(NEWID(), (SELECT Id FROM hr.PolicyVersion WHERE PolicyDocumentId=(SELECT Id FROM hr.PolicyDocument WHERE PolicyCode='POL-IT-001') AND VersionNumber=1), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP015'), 'OVERDUE',      '2021-04-15', NULL);


-- MODULE E: PERFORMANCE REVIEWS

PRINT 'Inserting hr.PerformanceCycle...';
INSERT INTO hr.PerformanceCycle (Id, CycleName, CycleType, StartDate, EndDate, GoalSettingDeadline, ReviewStartDate, ReviewEndDate, CycleStatus, LegalEntityId, CreatedBy) VALUES
(NEWID(), 'Annual Appraisal 2023 - MedCare India',       'ANNUAL',   '2023-01-01', '2023-12-31', '2023-02-28', '2024-01-15', '2024-02-28', 'COMPLETED',    (SELECT Id FROM time.LegalEntity WHERE EntityCode='MEDCARE-IN'),    (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005')),
(NEWID(), 'Annual Appraisal 2024 - MedCare India',       'ANNUAL',   '2024-01-01', '2024-12-31', '2024-02-29', '2025-01-15', '2025-02-28', 'COMPLETED',    (SELECT Id FROM time.LegalEntity WHERE EntityCode='MEDCARE-IN'),    (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005')),
(NEWID(), 'Annual Appraisal 2024 - MedCare North',       'ANNUAL',   '2024-01-01', '2024-12-31', '2024-02-29', '2025-01-15', '2025-02-28', 'COMPLETED',    (SELECT Id FROM time.LegalEntity WHERE EntityCode='MEDCARE-NORTH'), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP019')),
(NEWID(), 'Annual Appraisal 2024 - MedCare South',       'ANNUAL',   '2024-01-01', '2024-12-31', '2024-02-29', '2025-01-15', '2025-02-28', 'COMPLETED',    (SELECT Id FROM time.LegalEntity WHERE EntityCode='MEDCARE-SOUTH'), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP019')),
(NEWID(), 'Probation Review - Q3 2023 Joiners',          'PROBATION','2023-08-01', '2024-01-31', '2023-09-15', '2024-01-15', '2024-01-31', 'COMPLETED',    NULL,                                                          (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005')),
(NEWID(), 'Annual Appraisal 2025 - All Entities',        'ANNUAL',   '2025-01-01', '2025-12-31', '2025-03-31', '2026-01-15', '2026-02-28', 'GOAL_SETTING', NULL,                                                          (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP005'));


PRINT 'Inserting hr.Goal (2024 cycle - sample employees)...';
-- EMP003 Dr. Arjun Mehta - Senior Cardiac Surgeon - 2024 Annual
INSERT INTO hr.Goal (Id, EmployeeId, PerformanceCycleId, Title, Description, Category, WeightagePct, TargetDate, GoalStatus, ProgressPct, EmployeeRating, ManagerRating, ApprovedByEmployeeId) VALUES
(
    NEWID(), 
...
INSERT INTO hr.Goal (Id, EmployeeId, PerformanceCycleId, Title, Description, Category, WeightagePct, TargetDate, GoalStatus, ProgressPct, EmployeeRating, ManagerRating) VALUES
(
    NEWID(), 
    (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP009'),
...
INSERT INTO hr.GoalKeyResult (Id, GoalId, Description, TargetValue, ActualValue, KRStatus) VALUES
(
    NEWID(), 
...
INSERT INTO hr.PerformanceReview (Id, EmployeeId, PerformanceCycleId, ReviewerEmployeeId, SelfRating, ManagerRating, FinalRating, PerformanceBand, SelfComments, ManagerComments, HRBPComments, ReviewStatus, SelfSubmittedAt, ManagerSubmittedAt, CompletedAt) VALUES
(
    NEWID(), 
    (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP003'),
    (SELECT Id FROM hr.PerformanceCycle WHERE CycleName='Annual Appraisal 2024 - MedCare India'),
...
INSERT INTO hr.PerformanceReview (Id, EmployeeId, PerformanceCycleId, ReviewerEmployeeId, ReviewStatus) VALUES
(
    NEWID(), 
    (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP009'),
    (SELECT Id FROM hr.PerformanceCycle WHERE CycleName='Annual Appraisal 2025 - All Entities'),
...
INSERT INTO hr.PerformanceReview (Id, EmployeeId, PerformanceCycleId, ReviewerEmployeeId, SelfRating, ManagerRating, FinalRating, PerformanceBand, SelfComments, ManagerComments, ReviewStatus, SelfSubmittedAt, ManagerSubmittedAt, CompletedAt) VALUES
(
    NEWID(), 
...
INSERT INTO hr.TrainingProgram (Id, TrainingCategory, ProgramCode, Title, Description, TrainingMode, DurationHours, Provider, IsMandatory, ApplicableTo, MaxParticipants, CertificateProvided) VALUES
(NEWID(), 'COMPLIANCE', 'TRN-BLS-001', 'Basic Life Support (BLS) Certification', 'Hands-on BLS certification covering CPR, AED operation, and choking response for adults, children, and infants.', 'OFFLINE', 8.0, 'American Heart Association (AHA)', 1, 'All Employees', 20, 1),
(NEWID(), 'COMPLIANCE', 'TRN-CMP-002', 'Workplace Safety and Fire Prevention', 'Covers fire safety protocols, emergency evacuation procedures, and workplace hazard prevention.', 'OFFLINE', 6.0, 'National Safety Council', 1, 'All Employees', 30, 1),
(NEWID(), 'TECHNICAL', 'TRN-TECH-001', 'Advanced SQL and Database Optimization', 'Training on indexing, execution plans, query optimization, and SQL Server performance tuning.', 'ONLINE', 16.0, 'Microsoft Learn', 0, 'IT Employees', 25, 1),
(NEWID(), 'TECHNICAL', 'TRN-TECH-002', 'Cloud Computing Fundamentals', 'Introduction to cloud platforms, virtualization, storage, and deployment models.', 'ONLINE', 12.0, 'AWS Academy', 0, 'IT Employees', 40, 1),
(NEWID(), 'LEADERSHIP', 'TRN-LDR-001', 'Leadership and Team Management', 'Develops leadership, delegation, team-building, and decision-making skills.', 'HYBRID', 10.0, 'Harvard Business Publishing', 0, 'Managers', 20, 1),
(NEWID(), 'LEADERSHIP', 'TRN-LDR-002', 'Conflict Resolution and Negotiation', 'Provides strategies for resolving workplace conflicts and improving negotiation outcomes.', 'HYBRID', 8.0, 'Dale Carnegie', 0, 'Managers and Team Leads', 25, 1),
(NEWID(), 'SOFT_SKILLS', 'TRN-SFT-001', 'Effective Communication Skills', 'Improves verbal, written, and interpersonal communication skills.', 'ONLINE', 6.0, 'Coursera', 0, 'All Employees', 50, 1),
(NEWID(), 'SOFT_SKILLS', 'TRN-SFT-002', 'Time Management and Productivity', 'Focuses on prioritization, scheduling, and productivity improvement techniques.', 'ONLINE', 5.0, 'Udemy', 0, 'All Employees', 60, 1),
(NEWID(), 'DOMAIN', 'TRN-DOM-001', 'Healthcare Regulatory Standards', 'Training on healthcare compliance, patient safety, and regulatory standards.', 'OFFLINE', 10.0, 'National Healthcare Institute', 1, 'Healthcare Staff', 30, 1),
(NEWID(), 'DOMAIN', 'TRN-DOM-002', 'Banking Risk and Compliance', 'Covers banking regulations, fraud prevention, and financial risk management.', 'ONLINE', 9.0, 'Institute of Banking Studies', 1, 'Finance Employees', 35, 1);

PRINT 'Inserting hr.TrainingBatch...';
INSERT INTO hr.TrainingBatch (Id, TrainingProgramId, BatchName, FacilitatorEmployeeId, StartDate, EndDate, VenueOrLink, MaxSeats, BatchStatus) VALUES
(NEWID(), (SELECT Id FROM hr.TrainingProgram WHERE ProgramCode = 'TRN-BLS-001'), 'BLS Batch - January 2025 - Mumbai', (SELECT Id FROM employee.Employee WHERE EmployeeCode = 'EMP004'), '2025-01-18', '2025-01-18', 'MedCare Mumbai HQ - Simulation Lab, Floor 2', 20, 'COMPLETED'),
(NEWID(), (SELECT Id FROM hr.TrainingProgram WHERE ProgramCode = 'TRN-CMP-002'), 'Workplace Safety Workshop - February 2025', (SELECT Id FROM employee.Employee WHERE EmployeeCode = 'EMP003'), '2025-02-08', '2025-02-08', 'MedCare Mumbai HQ - Safety Training Hall', 30, 'COMPLETED'),
(NEWID(), (SELECT Id FROM hr.TrainingProgram WHERE ProgramCode = 'TRN-TECH-001'), 'Advanced SQL Bootcamp - Q1 2025', (SELECT Id FROM employee.Employee WHERE EmployeeCode = 'EMP007'), '2025-01-10', '2025-01-12', 'https://lms.medcareindia.com/courses/TRN-TECH-001', 25, 'COMPLETED'),
(NEWID(), (SELECT Id FROM hr.TrainingProgram WHERE ProgramCode = 'TRN-TECH-002'), 'Cloud Computing Fundamentals - March 2025', (SELECT Id FROM employee.Employee WHERE EmployeeCode = 'EMP008'), '2025-03-05', '2025-03-06', 'MedCare Mumbai HQ - IT Training Room, Floor 3', 40, 'COMPLETED'),
(NEWID(), (SELECT Id FROM hr.TrainingProgram WHERE ProgramCode = 'TRN-LDR-001'), 'Leadership Excellence Program - FY2025', (SELECT Id FROM employee.Employee WHERE EmployeeCode = 'EMP010'), '2025-02-15', '2025-02-16', 'https://lms.medcareindia.com/courses/TRN-LDR-001', 20, 'COMPLETED'),
(NEWID(), (SELECT Id FROM hr.TrainingProgram WHERE ProgramCode = 'TRN-LDR-002'), 'Conflict Resolution Workshop - April 2025', (SELECT Id FROM employee.Employee WHERE EmployeeCode = 'EMP011'), '2025-04-05', '2025-04-05', 'MedCare Mumbai HQ - Conference Room A', 25, 'COMPLETED'),
(NEWID(), (SELECT Id FROM hr.TrainingProgram WHERE ProgramCode = 'TRN-SFT-001'), 'Communication Skills Enhancement - Q1 2025', NULL, '2025-01-20', '2025-01-25', 'https://lms.medcareindia.com/courses/TRN-SFT-001', 50, 'COMPLETED'),
(NEWID(), (SELECT Id FROM hr.TrainingProgram WHERE ProgramCode = 'TRN-SFT-002'), 'Productivity and Time Management - May 2025', NULL, '2025-05-01', '2025-05-07', 'https://lms.medcareindia.com/courses/TRN-SFT-002', 60, 'UPCOMING'),
(NEWID(), (SELECT Id FROM hr.TrainingProgram WHERE ProgramCode = 'TRN-DOM-001'), 'Healthcare Regulatory Standards - April 2025', (SELECT Id FROM employee.Employee WHERE EmployeeCode = 'EMP029'), '2025-04-10', '2025-04-11', 'MedCare Chennai Hospital - Training Center', 30, 'COMPLETED'),
(NEWID(), (SELECT Id FROM hr.TrainingProgram WHERE ProgramCode = 'TRN-DOM-002'), 'Banking Risk and Compliance - June 2025', (SELECT Id FROM employee.Employee WHERE EmployeeCode = 'EMP030'), '2025-06-12', '2025-06-13', 'MedCare Finance Division - Board Room', 35, 'UPCOMING');

PRINT 'Inserting hr.EmployeeTrainingRecord...';
INSERT INTO hr.EmployeeTrainingRecord (Id, EmployeeId, TrainingProgramId, TrainingBatchId, EnrolledDate, CompletedDate, RecordStatus, Score, PassingScore, CertificateUrl, CertificateIssuedDate, Feedback) VALUES
...
(NEWID(), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP021'), (SELECT Id FROM hr.TrainingProgram WHERE ProgramCode='TRN-LDR-001'), (SELECT Id FROM hr.TrainingBatch WHERE BatchName='Leadership Excellence Program - FY2025'), '2025-02-01', NULL, 'IN_PROGRESS', NULL, 75.00, NULL, NULL, NULL),
...
(NEWID(), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP030'), (SELECT Id FROM hr.TrainingProgram WHERE ProgramCode='TRN-SFT-002'), (SELECT Id FROM hr.TrainingBatch WHERE BatchName='Productivity and Time Management - May 2025'), '2025-05-01', NULL, 'ENROLLED', NULL, 70.00, NULL, NULL, NULL),
...
(NEWID(), (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP040'), (SELECT Id FROM hr.TrainingProgram WHERE ProgramCode='TRN-DOM-002'), (SELECT Id FROM hr.TrainingBatch WHERE BatchName='Banking Risk and Compliance - June 2025'), '2025-05-25', NULL, 'ENROLLED', NULL, 75.00, NULL, NULL, NULL);
-- MODULE G: EXIT MANAGEMENT

PRINT 'Inserting hr.ExitReason...';
INSERT INTO hr.ExitReason (Id, ReasonText, Category) VALUES
(NEWID(), 'Better Career Opportunity',           'VOLUNTARY'),
(NEWID(), 'Higher Compensation Elsewhere',       'VOLUNTARY'),
(NEWID(), 'Relocation - Personal Reasons',       'VOLUNTARY'),
(NEWID(), 'Family Obligations',                  'VOLUNTARY'),
(NEWID(), 'Health Reasons',                      'VOLUNTARY'),
(NEWID(), 'Higher Education / Research',         'VOLUNTARY'),
(NEWID(), 'Entrepreneurship',                    'VOLUNTARY'),
(NEWID(), 'Dissatisfaction with Work Environment','VOLUNTARY'),
(NEWID(), 'Lack of Growth Opportunities',        'VOLUNTARY'),
(NEWID(), 'Performance-Based Termination',       'INVOLUNTARY'),
(NEWID(), 'Misconduct / Disciplinary Action',    'INVOLUNTARY'),
(NEWID(), 'Redundancy / Role Elimination',       'INVOLUNTARY'),
(NEWID(), 'Contract Completion',                 'INVOLUNTARY'),
(NEWID(), 'Superannuation / Retirement',         'INVOLUNTARY'),
(NEWID(), 'Absconding Without Notice',           'INVOLUNTARY');

PRINT 'Inserting hr.ExitRecord (samples)...';
-- EMP015 Suresh Naidu - Front Desk - Resigned for better opportunity (Mumbai)
INSERT INTO hr.ExitRecord (Id, EmployeeId, ExitReasonId, ExitType, AdditionalReason, ResignationDate, LastWorkingDate, NoticePeriodDays, IsNoticeWaived, ExitInterviewStatus, ExitInterviewDate, ConductedByEmployeeId, ExitFeedback, IsRehireEligible, ClearanceStatus, FinalSettlementStatus, FinalSettlementDate, CreatedBy) VALUES
(
    NEWID(), 
...
INSERT INTO hr.ExitRecord (Id, EmployeeId, ExitReasonId, ExitType, AdditionalReason, ResignationDate, LastWorkingDate, NoticePeriodDays, IsNoticeWaived, ExitInterviewStatus, ExitInterviewDate, ConductedByEmployeeId, ExitFeedback, IsRehireEligible, ClearanceStatus, FinalSettlementStatus, CreatedBy) VALUES
(
    NEWID(), 
...
INSERT INTO hr.ExitClearanceItem (Id, ExitRecordId, ItemName, OwnerDepartment, ItemStatus, CompletedByEmployeeId, CompletedAt, Remarks) VALUES
(NEWID(), (SELECT Id FROM hr.ExitRecord WHERE EmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP015')), 'ID Card and Access Badge returned',        'HR',           'COMPLETED', (SELECT Id FROM  employee.Employee WHERE EmployeeCode='EMP005'), '2025-04-14 17:00:00', 'ID card collected on last working day'),
(NEWID(), (SELECT Id FROM hr.ExitRecord WHERE EmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP015')), 'Laptop and company assets returned',        'IT',           'COMPLETED', (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'), '2025-04-14 16:00:00', 'Laptop in good condition; charger returned'),
(NEWID(), (SELECT Id FROM hr.ExitRecord WHERE EmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP015')), 'System and EHR access revoked',             'IT',           'COMPLETED', (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP007'), '2025-04-14 18:00:00', 'All user accounts deactivated'),
(NEWID(), (SELECT Id FROM hr.ExitRecord WHERE EmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP015')), 'Finance clearance and dues settled',        'Finance',      'COMPLETED', (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP006'), '2025-04-18 11:00:00', 'No outstanding advances; petty cash reconciled'),
(NEWID(), (SELECT Id FROM hr.ExitRecord WHERE EmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP015')), 'Uniform and workwear returned',             'Admin',        'COMPLETED', (SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP014'), '2025-04-14 17:30:00', '2 sets of uniform returned'),
(NEWID(), (SELECT Id FROM hr.ExitRecord WHERE EmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP015')), 'Knowledge transfer to replacement',         'Admin',        'WAIVED',    NULL,                                                  NULL,                  'Role is being held vacant; KT waived per manager approval');

-- EMP013 - Clearances in progress
INSERT INTO hr.ExitClearanceItem (Id, ExitRecordId, ItemName, OwnerDepartment, ItemStatus, CompletedByEmployeeId, CompletedAt, Remarks) VALUES
(NEWID(), (SELECT Id FROM hr.ExitRecord WHERE EmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP013')), 'ID Card and Access Badge returned',        'HR',           'PENDING',   NULL, NULL, NULL),
(NEWID(), (SELECT Id FROM hr.ExitRecord WHERE EmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP013')), 'System and EHR access revoked',             'IT',           'PENDING',   NULL, NULL, 'To be done on last working day'),
(NEWID(), (SELECT Id FROM hr.ExitRecord WHERE EmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP013')), 'Pharmacy drug register handover',           'Pharmacy',     'COMPLETED',(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP012'), NULL, 'Chief pharmacist conducting handover with EMP013 this week'),
(NEWID(), (SELECT Id FROM hr.ExitRecord WHERE EmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP013')), 'Finance clearance and dues settled',        'Finance',      'PENDING',   NULL, NULL, 'Full and final calculation pending payroll processing'),
(NEWID(), (SELECT Id FROM hr.ExitRecord WHERE EmployeeId=(SELECT Id FROM employee.Employee WHERE EmployeeCode='EMP013')), 'Uniform and workwear returned',             'Admin',        'PENDING',   NULL, NULL, NULL);
